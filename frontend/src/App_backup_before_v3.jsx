...
function VisitsPage({user,shops,profiles,visits,setVisits,canApprove}){
  ...
  const visibleVisits=visits.filter(v=>{
    ...
    return d===dateF && (["Admin","MD","Chief Manager","Monitoring Manager"].includes(user.role) || owner===user.id);
  });
  ...
  return <div>
    ...
    <Card style={{marginBottom:24}}>
      <div style={{fontSize:16,fontWeight:700,color:"#1F1F1F",marginBottom:16}}>🛒 Start Shop Visit</div>
    ...
    <Card style={{padding:0,overflow:"hidden"}}>
      <Table headers={["Staff","Shop","Check-in","Check-out","Duration","Status","Before","After","Approval"]}
