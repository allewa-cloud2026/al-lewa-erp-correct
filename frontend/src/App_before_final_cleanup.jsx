...
function LoginScreen({company_settings,loginForm,setLoginForm,loginError,onLogin}){
  return <div className="lewa-login-screen" style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Segoe UI', -apple-system, BlinkMacSystemFont, sans-serif",background:"linear-gradient(160deg, #E8F5F1 0%, #0B6B2E 52%, #084B20 100%)",padding:24}}>
...
export default function App(){
  ...
  const globalPwaStyles=<style>{`
    ...
    @media (max-width: 767px) {
      ...
      .lewa-table-wrap:not(.lewa-visits-table) thead,
      .lewa-table-wrap:not(.lewa-visits-table) tr,
      .lewa-table-wrap:not(.lewa-visits-table) td {
        display: revert !important;
        width: auto !important;
      }
      .lewa-visits-table thead {
        display: none !important;
      }
      .lewa-visits-table table,
      .lewa-visits-table tbody,
      .lewa-visits-table tr,
      .lewa-visits-table th,
      .lewa-visits-table td {
        display: block !important;
        width: 100% !important;
        box-sizing: border-box !important;
      }
      ...
      .lewa-visits-table td:last-child {
  ...
  return(
    <div className="lewa-app-shell" style={{display:"flex",height:"100vh",fontFamily:'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Arial, sans-serif',background:"var(--lewa-shell)",overflow:"hidden"}}>
      {globalPwaStyles}
      {systemBanners}
      {sidebarOpen&&<div className="lewa-sidebar-scrim" onClick={()=>{setSidebarOpen(false);setMobileMoreOpen(false);}} />}
      {/* SIDEBAR */}
      <div className={`lewa-sidebar ${sidebarOpen?"is-open":"is-closed"}`} style={{width:sidebarOpen?220:62,flexShrink:0,background:"linear-gradient(180deg,var(--lewa-surface),var(--lewa-surface-2))",borderRight:"1.5px solid var(--lewa-border)",display:"flex",flexDirection:"column",transition:"width 0.2s ease",overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
        <div style={{padding:"12px 14px",borderBottom:"1.5px solid var(--lewa-border)",display:"flex",alignItems:"center",gap:14,minWidth:240,background:"linear-gradient(180deg,rgba(15,110,86,0.04),transparent)"}}>
          ...
          {sidebarOpen&&<div style={{minWidth:0}}><div style={{fontWeight:"700",fontSize:"14px",color:"var(--lewa-text)",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{company_settings.company_name}</div><div style={{fontSize:"10px",color:"var(--lewa-text-muted)",letterSpacing:"0.06em",marginTop:2}}>{company_settings.company_subtitle}</div></div>}
        ...
        <nav style={{flex:1,overflowY:"auto",padding:"10px 8px"}}>
          {navItems.map(item=>(
            <button key={item} onClick={()=>selectPage(item)}
              style={{display:"flex",alignItems:"center",gap:12,width:"100%",padding:"9px 10px",borderRadius:10,border:"none",cursor:"pointer",background:page===item?"#E8F5F1":"transparent",color:page===item?"#0F6E56":"#555555",fontWeight:page===item?"600":"500",fontSize:"13px",textAlign:"left",whiteSpace:"nowrap",position:"relative",transition:"all 0.2s"}}>
        ...
        {sidebarOpen&&<div style={{padding:"12px 14px",borderTop:"1.5px solid var(--lewa-border)",background:"var(--lewa-surface-2)"}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
      ...
      <div className="lewa-main-shell" style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column",background:"var(--lewa-shell)"}}>
        {/* TOPBAR */}
        <div className="lewa-topbar" style={{height:62,borderBottom:"1.5px solid rgba(255,255,255,0.16)",background:"linear-gradient(180deg, #0F6E56 0%, #0C5B47 100%)",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 28px",flexShrink:0,boxShadow:"0 6px 18px rgba(8,75,32,0.22)"}}>
          ...
          <div className="lewa-topbar-brand" style={{display:"flex",alignItems:"center",gap:14,flex:1,minWidth:0}}>
            ...
            <div style={{display:"flex",flexDirection:"column",minWidth:0,overflow:"hidden"}}>
              <span className="lewa-topbar-company" style={{fontSize:"15px",fontWeight:"700",color:"#FFFFFF",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{company_settings.company_name}</span>
              <span className="lewa-topbar-subtitle" style={{fontSize:"12px",color:"#D9FBEA",marginTop:4,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{company_settings.company_subtitle}</span>
          ...
          <div className="lewa-topbar-actions" style={{display:"flex",alignItems:"center",gap:14,flexWrap:"wrap",justifyContent:"flex-end"}}>
            <div className="lewa-topbar-page-title" style={{textAlign:"right"}}>
              <div style={{fontSize:"18px",fontWeight:"700",color:"#FFFFFF"}}>{page}</div>
              <div style={{fontSize:"12px",color:"#D9FBEA"}}>Enterprise ERP dashboard</div>
            </div>
