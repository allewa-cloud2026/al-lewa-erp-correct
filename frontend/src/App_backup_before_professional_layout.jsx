...
export default function App(){
  ...
  return(
    <div className="lewa-app-shell" style={{display:"flex",height:"100vh",fontFamily:"'Segoe UI', -apple-system, BlinkMacSystemFont, sans-serif",background:"#F5F5F7",overflow:"hidden"}}>
      ...
      {/* SIDEBAR */}
      <div className={`lewa-sidebar ${sidebarOpen?"is-open":"is-closed"}`} style={{width:sidebarOpen?240:62,flexShrink:0,background:"#0f3d24",borderRight:"none",display:"flex",flexDirection:"column",transition:"width 0.2s ease",overflow:"hidden",boxShadow:"2px 0 12px rgba(0,0,0,0.18)"}}>
        ...
        <nav style={{flex:1,overflowY:"auto",padding:"10px 8px"}}>
          {navItems.map(item=>(
            <button key={item} onClick={()=>selectPage(item)}
              style={{display:"flex",alignItems:"center",gap:12,width:"100%",padding:"10px 10px",borderRadius:8,border:"none",cursor:"pointer",background:page===item?"#EAF7EF":"transparent",color:page===item?"#0f3d24":"#EAF7EF",fontWeight:page===item?"600":"500",fontSize:"13px",textAlign:"left",whiteSpace:"nowrap",position:"relative",transition:"all 0.2s"}}>
      ...
      <div className="lewa-main-shell" style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column",background:"#F5F5F7"}}>
        {/* TOPBAR */}
        <div className="lewa-topbar" style={{height:84,borderBottom:"none",background:"#1a6b3c",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 24px",flexShrink:0,boxShadow:"0 2px 12px rgba(26,107,60,0.18)"}}>
          ...
          <div className="lewa-topbar-brand" style={{display:"flex",alignItems:"center",gap:14,flex:1,minWidth:0}}>
            <div className="lewa-topbar-logo" style={{width:54,height:54,display:"none",alignItems:"center",justifyContent:"center",background:"#F5F5F7",borderRadius:16,overflow:"hidden",border:"1px solid #E5E5E5",flexShrink:0}}>
              <img src={company_settings.company_logo_url||DEFAULT_LOGO} alt="Al Lewa General Trading LLC" style={{width:"100%",height:"100%",objectFit:"contain"}} />
            </div>
