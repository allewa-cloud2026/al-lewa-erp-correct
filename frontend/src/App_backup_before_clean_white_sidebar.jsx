...
const Btn = ({children,onClick,variant="default",size="md",style={}})=>{
  ...
  const variants={
    ...
    primary:{background:"#1a6b3c",color:"#FFFFFF",border:"none",fontWeight:"700",letterSpacing:"0.03em",boxShadow:"0 2px 8px rgba(26,107,60,0.18)"},
  ...
  return <div className="lewa-login-screen" style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Segoe UI', -apple-system, BlinkMacSystemFont, sans-serif",background:"#F5F5F7",padding:24}}>
    <div className="lewa-login-card" style={{width:"100%",maxWidth:420,background:"#FFFFFF",border:"1px solid #E5E5E5",borderRadius:16,boxShadow:"0 16px 45px rgba(15,110,86,0.10)",padding:30}}>
      ...
      {DEMO_MODE&&<div style={{marginTop:18,background:"#F9F9F9",border:"1px solid #E8E8E8",borderRadius:12,padding:14}}>
        ...
        <div style={{fontSize:12,color:"#666666",lineHeight:1.7}}>admin / admin123<br/>shakeel / shakeel123<br/>ashik / ashik123<br/>anees / anees123</div>
      </div>}
    </div>
  </div>;
}
...
export default function App(){
  ...
  return(
    <div className="lewa-app-shell" style={{display:"flex",height:"100vh",fontFamily:"'Segoe UI', -apple-system, BlinkMacSystemFont, sans-serif",background:"#F5F5F7",overflow:"hidden"}}>
      ...
      {/* SIDEBAR */}
      <div className={`lewa-sidebar ${sidebarOpen?"is-open":"is-closed"}`} style={{width:sidebarOpen?280:62,flexShrink:0,background:"#0f3d24",borderRight:"none",display:"flex",flexDirection:"column",transition:"width 0.2s ease",overflow:"hidden",boxShadow:"2px 0 12px rgba(0,0,0,0.18)"}}>
        <div style={{padding:"12px 14px",borderBottom:"1px solid #E5E5E5",display:"flex",alignItems:"center",gap:14,minWidth:240}}>
        ...
        <nav style={{flex:1,overflowY:"auto",padding:"10px 8px"}}>
          {navItems.map(item=>(
            <button key={item} onClick={()=>selectPage(item)}
              style={{display:"flex",alignItems:"center",gap:12,width:"100%",padding:"9px 10px",borderRadius:10,border:"none",cursor:"pointer",background:page===item?"#EAF7EF":"transparent",color:page===item?"#0f3d24":"#EAF7EF",fontWeight:page===item?"600":"500",fontSize:"13px",textAlign:"left",whiteSpace:"nowrap",position:"relative",transition:"all 0.2s"}}>
        ...
        {sidebarOpen&&<div style={{padding:"12px 14px",borderTop:"1px solid rgba(255,255,255,0.12)",background:"rgba(255,255,255,0.08)"}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
      ...
      <div className="lewa-main-shell" style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column",background:"#F5F5F7"}}>
        {/* TOPBAR */}
        <div className="lewa-topbar" style={{height:74,borderBottom:"none",background:"#1a6b3c",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 28px",flexShrink:0,boxShadow:"0 2px 12px rgba(26,107,60,0.18)"}}>
          ...
          <div className="lewa-topbar-brand" style={{display:"flex",alignItems:"center",gap:14,flex:1,minWidth:0}}>
            <div className="lewa-topbar-logo" style={{width:46,height:46,display:"none",alignItems:"center",justifyContent:"center",background:"#F5F5F7",borderRadius:16,overflow:"hidden",border:"1px solid #E5E5E5",flexShrink:0}}>
              <img src={company_settings.company_logo_url||DEFAULT_LOGO} alt="Al Lewa General Trading LLC" style={{width:"100%",height:"100%",objectFit:"contain"}} />
            </div>
