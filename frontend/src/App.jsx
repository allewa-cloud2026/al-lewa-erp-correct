...
const AUTH_CREDENTIALS = {
  ...
  shakeel:{username:"shakeel",password:"shakeel123",user_id:"u13"},
  ameen:{username:"ameen",password:"ameen123",user_id:"u14"}
};

const VISIT_TABLE = "shop_visits";
const ROUTE_TABLE = "daily_routes";
const ROUTE_STOP_TABLE = "daily_route_stops";
const VISIT_STATUSES = ["in_progress","completed","pending_review","approved","rejected","flagged"];
...
const ROUTE_STATUSES = ["draft","published","in_progress","completed","cancelled"];
const ROUTE_STATUS_LABELS = {draft:"Draft",published:"Published",in_progress:"In Progress",completed:"Completed",cancelled:"Cancelled"};
const STOP_STATUSES = ["pending","in_progress","completed","skipped"];
const STOP_STATUS_LABELS = {pending:"Pending",in_progress:"In Progress",completed:"Completed",skipped:"Skipped"};
...
const NAV_ITEMS = {
  "Admin":["Dashboard","Users & Authorization","Authorizations","Session Tracker","Shops & Locations","Geographic Areas","Product Master","Attendance","Daily Route Plan","Merchandiser Visits","Delivery Tracking","LPO Management","Sales Orders","Daily Scores","Backup Logs","Memo/Documents","Reports","Training / Demo Video","Notifications","Settings"],
  "MD":["Dashboard","Authorizations","Shops & Locations","Attendance","Daily Route Plan","Merchandiser Visits","Delivery Tracking","LPO Management","Sales Orders","Daily Scores","Memo/Documents","Reports","Training / Demo Video","Notifications","Settings"],
  "Chief Manager":["Dashboard","Authorizations","Shops & Locations","Attendance","Daily Route Plan","Merchandiser Visits","Delivery Tracking","LPO Management","Sales Orders","Daily Scores","Memo/Documents","Reports","Training / Demo Video","Notifications","Settings"],
  "Monitoring Manager":["Dashboard","Shops & Locations","Attendance","Daily Route Plan","Merchandiser Visits","Daily Scores","Memo/Documents","Reports","Training / Demo Video","Notifications","Settings"],
  "Merchandiser":["Dashboard","Shops & Locations","Attendance","Daily Route Plan","Merchandiser Visits","LPO Management","Daily Scores","Memo/Documents","Reports","Training / Demo Video","Notifications","Settings"],
  "Salesman":["Dashboard","Shops & Locations","LPO Management","Sales Orders","Daily Scores","Memo/Documents","Reports","Training / Demo Video","Notifications","Settings"],
  "Driver":["Dashboard","Shops & Locations","Delivery Tracking","Attendance","Memo/Documents","Reports","Training / Demo Video","Notifications","Settings"],
  "Accountant":["Dashboard","Shops & Locations","Product Master","Attendance","Delivery Tracking","LPO Management","Sales Orders","Daily Scores","Backup Logs","Memo/Documents","Reports","Training / Demo Video","Notifications","Settings"]
};

const ROLE_PAGE_ACCESS = {
  Admin:NAV_ITEMS.Admin,
  MD:NAV_ITEMS.MD,
  "Chief Manager":NAV_ITEMS["Chief Manager"],
  "Monitoring Manager":NAV_ITEMS["Monitoring Manager"],
  Merchandiser:NAV_ITEMS.Merchandiser,
  Salesman:NAV_ITEMS.Salesman,
  Driver:NAV_ITEMS.Driver,
  Accountant:NAV_ITEMS.Accountant,
};
const canAccessPageByRole=(role,page)=>(ROLE_PAGE_ACCESS[role]||[]).includes(page)||role==="Admin";
...
const MOCK_AREAS = [
  ...
  {id:"a6",name:"Shakeel SOH Route",region:"Al Batinah / Buraimi"}
];
const MOCK_SHOPS = [
  ...
  {id:"s_demo",name:"Demo Training Shop",branch:"Muscat Central",area_id:"a1",contact_person:"Training Desk",phone:"+968 9000 0014",latitude:23.5859,longitude:58.4059,gps_link:"https://maps.google.com/?q=23.5859,58.4059",assigned_merchandiser_id:"u14",location:"Muscat Central",status:"Active",demo_assignment:true},
  // Imported from SHAKEEL_SOH_ROUTE_STANDARDIZED.xlsx
  {id:"sr1",name:"Misbah Al Max (Ms Max)",branch:"Musannah",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Musannah",store_type:"Department Store / Supermarket",route_order:1,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr2",name:"Ramez Hypermarket",branch:"Musannah",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Musannah",store_type:"Hypermarket",route_order:2,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr3",name:"Lulu Hypermarket",branch:"Suwaiq",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Suwaiq",store_type:"Hypermarket",route_order:3,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr4",name:"Lulu Hypermarket",branch:"Bidaya",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Bidaya",store_type:"Hypermarket",route_order:4,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr5",name:"Marjan Hypermarket",branch:"Bidaya",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Bidaya",store_type:"Hypermarket",route_order:5,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr6",name:"Misbah Al Max (Ms Max)",branch:"Khaboura",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Khaboura",store_type:"Department Store / Supermarket",route_order:6,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr7",name:"Lulu Hypermarket",branch:"Khaboura",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Khaboura",store_type:"Hypermarket",route_order:7,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr8",name:"Makkah Hypermarket",branch:"Tharmad",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Tharmad",store_type:"Hypermarket",route_order:8,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr9",name:"Makkah Hypermarket",branch:"Sawadi",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Sawadi",store_type:"Hypermarket",route_order:9,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr10",name:"Makkah Hypermarket",branch:"Suwaiq",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Suwaiq",store_type:"Hypermarket",route_order:10,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr11",name:"Makkah Hypermarket",branch:"Musannah",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Musannah",store_type:"Hypermarket",route_order:11,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr12",name:"Makkah Hypermarket",branch:"Khaboura",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Khaboura",store_type:"Hypermarket",route_order:12,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr13",name:"Makkah Hypermarket 2",branch:"Tharmad",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Tharmad",store_type:"Hypermarket",route_order:13,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr14",name:"Ataya",branch:"Saham",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Saham",store_type:"Supermarket / Department Store",route_order:14,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr15",name:"Misbah Al Max (Ms Max)",branch:"Saham",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Saham",store_type:"Department Store / Supermarket",route_order:15,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr16",name:"X Mart",branch:"Sohar Gate",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Sohar Gate",store_type:"Supermarket",route_order:16,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr17",name:"Mall Mart",branch:"Sohar",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Sohar",store_type:"Supermarket",route_order:17,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr18",name:"Souq Sohar",branch:"Sohar",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Sohar",store_type:"Market / Supermarket",route_order:18,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr19",name:"Lulu Hypermarket",branch:"Sohar",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Sohar",store_type:"Hypermarket",route_order:19,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr20",name:"Ramez Hypermarket",branch:"Sohar",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Sohar",store_type:"Hypermarket",route_order:20,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr21",name:"Ataya",branch:"Sohar",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Sohar",store_type:"Supermarket / Department Store",route_order:21,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr22",name:"Al Mandoos",branch:"Sohar",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Sohar",store_type:"Traditional / Supermarket",route_order:22,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr23",name:"Lulu Hypermarket",branch:"Falaj",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Falaj",store_type:"Hypermarket",route_order:23,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr24",name:"Ataya",branch:"Liwa",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Liwa",store_type:"Supermarket / Department Store",route_order:24,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr25",name:"Makkah Hypermarket",branch:"Saham",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Saham",store_type:"Hypermarket",route_order:25,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr26",name:"Makkah Hypermarket",branch:"Liwa",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Liwa",store_type:"Hypermarket",route_order:26,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr27",name:"Makkah Hypermarket",branch:"Diyan",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Diyan",store_type:"Hypermarket",route_order:27,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr28",name:"Misbah Al Max (Ms Max)",branch:"Buraimi",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Buraimi",store_type:"Department Store / Supermarket",route_order:28,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr29",name:"Day To Day",branch:"Buraimi",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Buraimi",store_type:"Discount / Department Store",route_order:29,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr30",name:"Hyperland",branch:"Buraimi",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Buraimi",store_type:"Hypermarket",route_order:30,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr31",name:"Lulu Hypermarket",branch:"Buraimi",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Buraimi",store_type:"Hypermarket",route_order:31,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr32",name:"International Hypermarket",branch:"Musannah",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"Musannah",store_type:"Hypermarket",route_order:32,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr33",name:"Delma",branch:"General",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"General",store_type:"Supermarket / Trading",route_order:33,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
  {id:"sr34",name:"Rial Center",branch:"General",area_id:"a6",contact_person:"Route Checklist",phone:"",latitude:null,longitude:null,location:"General",store_type:"Discount Center / Supermarket",route_order:34,route_checklist:"SHAKEEL_SOH_ROUTE_STANDARDIZED",verification_status:"Pending Check",assigned_merchandiser_id:"u13",status:"Active"},
];
const MOCK_PROFILES = [
  ...
  {id:"u13",full_name:"Shakeel SOH Route",employee_id:"EMP-013",mobile:"+968 9100 0013",role:"Merchandiser",area_id:"a6",status:"Active",last_login:null,username:"shakeel",authorization_id:"AUTH-1013",device:"Mobile",location:"SOH Route"},
  {id:"u14",full_name:"Ameen",employee_id:"EMP-014",mobile:"+968 9100 0014",role:"Merchandiser",area_id:"a1",status:"Active",last_login:null,username:"ameen",authorization_id:"AUTH-1014",device:"Mobile",location:"Muscat Central"}
];
...
const MOCK_VISITS = [
  {id:"v1",user_id:"u4",shop_id:"s1",visit_date:"2025-06-25",status:"approved",distance_from_shop:0.12,gps_variance_detected:false,is_fake_visit:false,lpo_pdf_url:"lpo1.pdf",approval_status:"Approved"},
  {id:"v2",user_id:"u4",shop_id:"s3",visit_date:"2025-06-25",status:"in_progress",distance_from_shop:0.08,gps_variance_detected:false,is_fake_visit:false,approval_status:"Pending"},
  {id:"v3",user_id:"u7",shop_id:"s6",visit_date:"2025-06-25",status:"pending_review",distance_from_shop:null,gps_variance_detected:false,is_fake_visit:false,approval_status:"Pending"},
  {id:"v4",user_id:"u4",shop_id:"s2",visit_date:"2025-06-24",status:"approved",distance_from_shop:0.05,gps_variance_detected:false,is_fake_visit:false,approval_status:"Approved"},
  {id:"v5",user_id:"u10",shop_id:"s7",visit_date:"2025-06-25",status:"flagged",distance_from_shop:2.40,gps_variance_detected:true,is_fake_visit:false,approval_status:"Rejected",manager_comment:"GPS variance detected. Needs review."},
];
...
const MOCK_NOTIFICATIONS = [
  ...
  {id:"n2",user_id:"u1",title:"GPS variance detected",body:"Layla Al-Amri's visit to Carrefour Qurum is 2.4km away from shop.",type:"visit_incomplete",is_read:false,created_at:"2025-06-25T10:15:00Z"},
...
const MOCK_DAILY_ROUTES = [
  {id:"dr1",route_date:DEMO_TODAY,merchandiser_id:"u13",area_id:"a6",area_name:"Shakeel SOH Route",status:"published",notes:"SOH route plan for today",created_by:"u1",created_at:new Date().toISOString(),updated_at:new Date().toISOString()},
  {id:"dr2",route_date:DEMO_TODAY,merchandiser_id:"u4",area_id:"a3",area_name:"Al Batinah",status:"draft",notes:"Barka route draft",created_by:"u1",created_at:new Date().toISOString(),updated_at:new Date().toISOString()},
  {id:"dr3",route_date:DEMO_TODAY,merchandiser_id:"u14",area_id:"a1",area_name:"Muscat Central",status:"published",notes:"Demo training route for Ameen",created_by:"u1",created_at:new Date().toISOString(),updated_at:new Date().toISOString()}
];
const MOCK_DAILY_ROUTE_STOPS = [
  {id:"drs1",route_id:"dr1",shop_id:"sr1",sequence_no:1,status:"pending",assigned_visit_id:null,notes:"Start with Musannah department store",created_at:new Date().toISOString(),updated_at:new Date().toISOString()},
  {id:"drs2",route_id:"dr1",shop_id:"sr2",sequence_no:2,status:"pending",assigned_visit_id:null,notes:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()},
  {id:"drs3",route_id:"dr1",shop_id:"sr3",sequence_no:3,status:"pending",assigned_visit_id:null,notes:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()},
  {id:"drs4",route_id:"dr1",shop_id:"sr4",sequence_no:4,status:"pending",assigned_visit_id:null,notes:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()},
  {id:"drs5",route_id:"dr1",shop_id:"sr5",sequence_no:5,status:"pending",assigned_visit_id:null,notes:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()},
  {id:"drs6",route_id:"dr2",shop_id:"s1",sequence_no:1,status:"pending",assigned_visit_id:null,notes:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()},
  {id:"drs7",route_id:"dr2",shop_id:"s3",sequence_no:2,status:"pending",assigned_visit_id:null,notes:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()},
  {id:"drs8",route_id:"dr3",shop_id:"s_demo",sequence_no:1,status:"pending",assigned_visit_id:null,notes:"Demo training stop for Ameen",created_at:new Date().toISOString(),updated_at:new Date().toISOString()}
];
...
function normalizeVisitStatus(s){return LEGACY_VISIT_STATUS_MAP[s]||s||"pending_review";}
...
async function db(table, method="select", options={}){
  ...
  try{
    ...
    if(method==="insert"){const{data,error}=await q.insert(options.data).select();if(error)throw error;const rows=data||[];const current=readStoredTable(table,MOCK_DB[table]||[]);writeStoredTable(table,[...rows,...current.filter(r=>!rows.some(n=>n.id&&n.id===r.id))]);return rows;}
    if(method==="update"){let u=q.update(options.data);if(options.eq)Object.entries(options.eq).forEach(([k,v])=>{u=u.eq(k,v)});const{data,error}=await u.select();if(error)throw error;const current=readStoredTable(table,MOCK_DB[table]||[]);writeStoredTable(table,current.map(row=>options.eq&&Object.entries(options.eq).every(([k,v])=>row[k]===v)?{...row,...options.data}:row));return data;}
    if(method==="delete"){let del=q.delete();if(options.eq)Object.entries(options.eq).forEach(([k,v])=>{del=del.eq(k,v)});const{error}=await del;if(error)throw error;const current=readStoredTable(table,MOCK_DB[table]||[]);writeStoredTable(table,options.eq?current.filter(row=>!Object.entries(options.eq).every(([k,v])=>row[k]===v)):current);return true;}
  }catch(e){console.error("DB error",table,method,e);return demoDb(table, method, options);}
}
...
function readStoredTable(table, seed){
  if(typeof window==="undefined")return cloneRows(seed);
  const raw=window.localStorage.getItem(storageKey(table));
  if(raw==null)return cloneRows(seed);
  try{
    const parsed=JSON.parse(raw);
    return Array.isArray(parsed)?parsed:cloneRows(seed);
  }catch(e){
    console.warn("Ignoring invalid local data",table);
...
let mockState = Object.fromEntries(Object.keys(MOCK_DB).map(table=>[table,initialTable(table)]));
...
function demoDb(table, method, options){
  ...
  if(method==="insert"){
    const newRow={...options.data,id:options.data?.id||"new-"+Date.now()};
    mockState[table]=[newRow,...(mockState[table]||[])];
    writeStoredTable(table,mockState[table]);
...
const Badge = ({label,color,bg})=>(
  <span style={{display:"inline-block",padding:"4px 12px",borderRadius:6,fontSize:"12px",fontWeight:"500",background:bg||ROLE_BG[label]||"var(--lewa-surface-2)",color:color||ROLE_COLORS[label]||"var(--lewa-text-muted)",border:"1px solid var(--lewa-border)"}}>{label}</span>
);
const StatusBadge = ({s})=>{
  const c=statusColor(s);
  return <span style={{display:"inline-flex",alignItems:"center",gap:6,fontSize:"13px"}}>
    <span style={{width:8,height:8,borderRadius:"50%",background:c,flexShrink:0}}/>
    {VISIT_STATUS_LABELS[s]||ROUTE_STATUS_LABELS[s]||STOP_STATUS_LABELS[s]||s||"—"}
  </span>;
};
const Card = ({children,style={}})=>(
  <div className="lewa-card" style={{background:"var(--lewa-surface)",border:"1.5px solid var(--lewa-border)",borderRadius:16,padding:"1.35rem",boxShadow:"0 10px 28px rgba(15,110,86,0.08)",...style}}>{children}</div>
);
const StatCard = ({label,value,sub,color})=>(
  <div className="lewa-stat-card" style={{background:"var(--lewa-surface)",borderRadius:16,padding:"18px 20px",borderLeft:`4px solid ${color||"#0F6E56"}`,border:"1.5px solid var(--lewa-border)",boxShadow:"0 6px 18px rgba(0,0,0,0.05)"}}>
    <div style={{fontSize:"11px",color:"var(--lewa-text-muted)",marginBottom:8,fontWeight:"700",textTransform:"uppercase",letterSpacing:"0.14em"}}>{label}</div>
    <div style={{fontSize:"24px",fontWeight:"700",color:color||"var(--lewa-text)",marginBottom:4}}>{value}</div>
    {sub&&<div style={{fontSize:"12px",color:"var(--lewa-text-muted)",marginTop:2}}>{sub}</div>}
  </div>
);
const Btn = ({children,onClick,variant="default",size="md",style={}})=>{
  ...
  const variants={
    default:{background:"var(--lewa-surface)",color:"var(--lewa-text)",border:"1.5px solid var(--lewa-border)","&:hover":{background:"var(--lewa-surface-2)"}},
    primary:{background:"#0F6E56",color:"#FFFFFF",border:"none",fontWeight:"700",letterSpacing:"0.03em",boxShadow:"0 2px 8px rgba(26,107,60,0.18)"},
    danger:{background:"#B42318",border:"1.5px solid #B42318",color:"#FFFFFF","&:hover":{background:"#9F1F16"}},
    success:{background:"#0F6E56",border:"1.5px solid #0F6E56",color:"#FFFFFF","&:hover":{background:"#0C5B47"}},
    gold:{background:"#8D7320",border:"1.5px solid #8D7320",color:"#FFFFFF","&:hover":{background:"#755F1A"}},
    ghost:{background:"transparent",border:"none",color:"var(--lewa-text)","&:hover":{background:"var(--lewa-surface-2)"}}
  };
  const sizes={sm:{padding:"6px 12px",fontSize:"12px"},md:{padding:"9px 16px",fontSize:"13px"},lg:{padding:"12px 20px",fontSize:"14px"}};
  return <button data-variant={variant} onClick={onClick} style={{...base,...variants[variant],...sizes[size],...style}}>{children}</button>;
};
const ThemeToggle = ({isDark,onClick})=>(
  <button onClick={onClick} style={{display:"inline-flex",alignItems:"center",gap:10,border:"1.5px solid rgba(255,255,255,0.22)",borderRadius:16,padding:"8px 12px 8px 10px",background:"rgba(255,255,255,0.10)",color:"#FFFFFF",cursor:"pointer",boxShadow:"0 8px 18px rgba(0,0,0,0.12)",fontFamily:"inherit",fontWeight:700}}>
    <span style={{fontSize:17,lineHeight:1}}>{isDark?"🌙":"☀️"}</span>
    <span style={{fontSize:13,whiteSpace:"nowrap"}}>{isDark?"Dark Mode":"Light Mode"}</span>
    <span style={{display:"inline-flex",alignItems:"center",width:42,height:24,padding:3,borderRadius:999,background:isDark?"#16362D":"rgba(255,255,255,0.55)",border:"1px solid rgba(255,255,255,0.22)",boxSizing:"border-box",marginLeft:2}}>
      <span style={{width:18,height:18,borderRadius:"50%",background:"#FFFFFF",transform:isDark?"translateX(18px)":"translateX(0)",transition:"transform 0.2s ease, background 0.2s ease",boxShadow:"0 2px 6px rgba(0,0,0,0.22)"}} />
    </span>
  </button>
);
const Input = ({value,onChange,placeholder,type="text",style={}})=>(
  <input value={value||""} onChange={e=>onChange(e.target.value)} placeholder={placeholder} type={type}
    style={{padding:"9px 12px",border:"1.5px solid var(--lewa-border)",borderRadius:8,background:"var(--lewa-surface)",color:"var(--lewa-text)",fontSize:"13px",fontFamily:"inherit",width:"100%",transition:"border 0.2s","&:focus":{outline:"none",borderColor:"#0F6E56"},...style}}/>
);
const Select = ({value,onChange,children,style={}})=>(
  <select value={value||""} onChange={e=>onChange(e.target.value)}
    style={{padding:"8px 12px",border:"1.5px solid var(--lewa-border)",borderRadius:8,background:"var(--lewa-surface)",color:"var(--lewa-text)",fontSize:"13px",fontFamily:"inherit",cursor:"pointer",...style}}>
    {children}
  </select>
);
const Modal = ({title,children,onClose,width=540})=>(
  <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:200}} onClick={e=>{if(e.target===e.currentTarget)onClose()}}>
    <div style={{background:"var(--lewa-surface)",borderRadius:12,border:"1.5px solid var(--lewa-border)",width,maxWidth:"95vw",maxHeight:"85vh",overflowY:"auto",padding:28,boxShadow:"0 20px 60px rgba(0,0,0,0.15)"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:24}}>
        <span style={{fontSize:"17px",fontWeight:"600",color:"var(--lewa-text)"}}>{title}</span>
...
const Table = ({headers,rows,className=""})=>(
  <div className={`lewa-table-wrap ${className}`.trim()} style={{overflowX:"auto",borderRadius:14,boxShadow:"0 10px 30px rgba(0,0,0,0.04)"}}>
    <table style={{width:"100%",borderCollapse:"separate",borderSpacing:"0 10px",fontSize:"13px"}}>
      <thead>
        <tr>
          {headers.map((h,i)=><th key={i} style={{position:"sticky",top:0,zIndex:3,padding:"14px 16px",textAlign:"left",fontWeight:"700",fontSize:"12px",color:"var(--lewa-text-muted)",textTransform:"uppercase",letterSpacing:"0.08em",background:"var(--lewa-surface-2)",borderBottom:"1.5px solid var(--lewa-border)",whiteSpace:"nowrap"}}>{h}</th>)}
        </tr>
      </thead>
      <tbody>
        {rows.map((r,i)=><tr key={i} style={{background:"var(--lewa-surface)",borderRadius:12,boxShadow:i%2===0?"0 0 0 0 transparent":"none",transition:"background 0.2s",border:"1.5px solid var(--lewa-border)"}} onMouseOver={e=>e.currentTarget.style.background="var(--lewa-surface-2)"} onMouseOut={e=>e.currentTarget.style.background="var(--lewa-surface)"}>
          {r.map((c,j)=><td key={j} data-label={headers[j]} style={{padding:"14px 16px",color:"var(--lewa-text)",verticalAlign:"middle",whiteSpace:"nowrap",borderBottom:"1px solid var(--lewa-border)"}}>{c}</td>)}
        </tr>)}
      </tbody>
    </table>
  </div>
...
const PageHeader = ({title,subtitle,action})=>(
  <div className="lewa-page-header" style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",marginBottom:"2rem",flexWrap:"wrap",gap:16}}>
    <div>
      <h1 style={{fontSize:"26px",fontWeight:"600",color:"var(--lewa-text)",margin:0}}>{title}</h1>
      {subtitle&&<p style={{fontSize:"13px",color:"var(--lewa-text-muted)",marginTop:6,fontWeight:"400"}}>{subtitle}</p>}
    </div>
    {action}
  </div>
);
...
function Dashboard({user,areas,shops,profiles,attendance,visits,deliveries,lpos,scores,notifications,authorizations,backup_logs,login_sessions,setPage}){
  ...
  const gpsVarianceVisits=todayVisits.filter(v=>v.gps_variance_detected||proximityStatus(v.distance_from_shop)==="Suspicious").length;
  ...
  const quickAccess=[
    ...
    {label:"Daily Route Plan",icon:"🗺️",page:"Daily Route Plan"},
  ...
  return <div>
    <Card style={{marginBottom:12}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,marginBottom:12,flexWrap:"wrap"}}>
        <div>
          <div style={{fontSize:"14px",fontWeight:700,color:"var(--lewa-text)"}}>Quick access</div>
          <div style={{fontSize:"12px",color:"var(--lewa-text-muted)",marginTop:2}}>Open the main ERP modules from one compact view.</div>
        </div>
        <Badge label="Overview" />
      </div>
      <div className="lewa-dashboard-kpis" style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(150px,1fr))",gap:8}}>
      {quickAccess.map(item=><button key={item.page} onClick={()=>setPage(item.page)} style={{border:"1.5px solid var(--lewa-border)",background:"linear-gradient(180deg,var(--lewa-surface),var(--lewa-surface-2))",padding:"13px 14px",borderRadius:14,display:"flex",alignItems:"center",gap:12,justifyContent:"space-between",cursor:"pointer",fontWeight:700,color:"var(--lewa-text)",boxShadow:"0 6px 16px rgba(0,0,0,0.05)",transition:"transform 0.18s ease, box-shadow 0.18s ease, border-color 0.18s ease"}}>
        <span style={{fontSize:20,display:"inline-flex",alignItems:"center",justifyContent:"center",width:34,height:34,borderRadius:10,background:"rgba(15,110,86,0.10)",border:"1px solid rgba(15,110,86,0.14)"}}>{item.icon}</span>
        <span style={{flex:1,textAlign:"left",fontSize:13,lineHeight:1.25}}>{item.label}</span>
    ...
    {isAdmin&&<>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(170px,1fr))",gap:10,marginBottom:12}}>
        ...
        <StatCard label="GPS variance visits" value={gpsVarianceVisits} color="#C74C51" sub="Needs review"/>
    ...
    {(isMerch||isSales||isDriver)&&<>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(150px,1fr))",gap:12,marginBottom:16}}>
        {isMerch&&<>
          ...
          <StatCard label="Completed" value={todayVisits.filter(v=>v.user_id===user.id&&["completed","pending_review","approved"].includes(normalizeVisitStatus(v.status))).length} color="#0F6E56"/>
    ...
    <Card style={{maxWidth:1100,margin:"0 auto",overflowX:"hidden"}}>
      ...
      <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:12,flexWrap:"wrap",marginBottom:12}}>
        <div style={{minWidth:0,flex:1}}>
          <div style={{fontSize:18,fontWeight:800,color:"var(--lewa-text)",marginBottom:4}}>Merchandiser Daily Workflow</div>
          <div style={{fontSize:13,color:"var(--lewa-text-muted)",lineHeight:1.4}}>Follow these steps in order to complete a clean, compliant shop visit and route day.</div>
        </div>
      </div>

      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(250px, 1fr))",gap:12,marginBottom:18}}>
        {workflow.map((step,idx)=>(
          <button key={step} type="button" style={{display:"flex",alignItems:"flex-start",gap:12,width:"100%",minHeight:74,padding:"14px",textAlign:"left",borderRadius:14,border:"1.5px solid var(--lewa-border)",background:"var(--lewa-surface-2)",color:"var(--lewa-text)",boxShadow:"inset 0 0 0 1px rgba(11,107,46,0.04)",cursor:"pointer"}}>
            <span style={{width:34,height:34,borderRadius:999,display:"inline-flex",alignItems:"center",justifyContent:"center",flexShrink:0,fontSize:14,fontWeight:800,background:"linear-gradient(180deg, rgba(11,107,46,0.16), rgba(11,107,46,0.08))",color:"#0B6B2E",border:"1.5px solid rgba(11,107,46,0.20)"}}>{idx+1}</span>
            <span style={{fontSize:14,fontWeight:700,lineHeight:1.35,whiteSpace:"normal"}}>{step}</span>
          </button>
        ))}
      </div>

      <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10}}>
        <div style={{fontSize:16,fontWeight:800,color:"var(--lewa-text)",margin:0}}>Important Rules</div>
      </div>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(260px, 1fr))",gap:10}}>
        {rules.map(rule=>(
          <div key={rule} style={{padding:"12px 14px",borderRadius:14,border:"1.5px solid var(--lewa-border)",background:"var(--lewa-surface)",color:"var(--lewa-text)",fontSize:13,lineHeight:1.45}}>
            {rule}
          </div>
        ))}
      </div>
...
// VISITS
function VisitsPage({user,shops,profiles,visits,setVisits,areas,canApprove,daily_routes,daily_route_stops,setDailyRoutes,setDailyRouteStops}){
  const today=new Date().toISOString().split("T")[0];
  ...
  const activeRoute=(daily_routes||[]).find(r=>
    r.route_date===today &&
    r.merchandiser_id===user.id &&
    ["published","in_progress","completed"].includes(r.status)
  );
  const todayRouteStops=activeRoute
    ? (daily_route_stops||[]).filter(s=>s.route_id===activeRoute.id).sort((a,b)=>(a.sequence_no||0)-(b.sequence_no||0))
    : [];
  const routeShopIds=new Set(todayRouteStops.map(s=>s.shop_id));
  const routeAssignedShops=todayRouteStops.map(stop=>shops.find(s=>s.id===stop.shop_id)).filter(Boolean);
  const availableAssignedShops=shops.filter(s=>
    !routeShopIds.has(s.id) && (
      s.assigned_merchandiser_id===user.id ||
      s.merchandiser_id===user.id ||
      (user.area_id && s.area_id===user.area_id)
    )
  );
  const assignedShops=isManager ? shops : [...routeAssignedShops,...availableAssignedShops];
  ...
  const visitStatus=v=>normalizeVisitStatus(v.status);
  const hasGpsVariance=v=>Boolean(v.gps_variance_detected)||visitGpsStatus(v)==="Suspicious"||Number(v.distance_from_shop)>0.5;
  const visitForStop=stop=>visits.find(v=>v.id===stop.assigned_visit_id) ||
    visits.find(v=>visitOwnerId(v)===user.id&&v.shop_id===stop.shop_id&&visitDate(v)===today);
  const currentPendingStop=todayRouteStops.find(stop=>!visitForStop(stop)&&stop.status==="pending");

  useEffect(()=>{
    if(isManager)return;
    const existing=visits.find(v=>
      visitOwnerId(v)===user.id &&
      visitDate(v)===today &&
      visitStatus(v)==="in_progress"
    );
    setActiveVisit(existing||null);
    if(existing){
      setForm(f=>({
        ...f,
        shop_id:f.shop_id||existing.shop_id||"",
        route_stop_id:f.route_stop_id||existing.route_stop_id||"",
        display_notes:f.display_notes||existing.display_notes||existing.notes||"",
        stock_issue:f.stock_issue||existing.stock_issue||"",
        competitor_activity:f.competitor_activity||existing.competitor_activity||"",
        order_request:f.order_request||existing.order_request||"",
        before_image_url:f.before_image_url||existing.before_image_url||""
      }));
    }
  },[visits,user.id,isManager,today]);

  const updateRouteStop=async(stopId,data)=>{
    if(!stopId)return;
    const payload={...data,updated_at:new Date().toISOString()};
    // Live Supabase migration required: create daily_route_stops before route-linked visit updates can persist.
    await db(ROUTE_STOP_TABLE,"update",{data:payload,eq:{id:stopId}});
    setDailyRouteStops?.(prev=>prev.map(s=>s.id===stopId?{...s,...payload}:s));
  };

  const updateRouteStatus=async(routeId,status)=>{
    if(!routeId)return;
    const payload={status,updated_at:new Date().toISOString()};
    // Live Supabase migration required: create daily_routes before route status updates can persist.
    await db(ROUTE_TABLE,"update",{data:payload,eq:{id:routeId}});
    setDailyRoutes?.(prev=>prev.map(r=>r.id===routeId?{...r,...payload}:r));
  };
  ...
  const visibleVisits=visits.filter(v=>{
    ...
    const statusOk=!filters.status ||
      (filters.status==="gps_variance"
        ? hasGpsVariance(v)
        : visitStatus(v)===filters.status || String(v.approval_status||"").toLowerCase()===filters.status.toLowerCase());
    return dateOk&&ownerOk&&merchOk&&shopOk&&areaOk&&statusOk;
  });

  const startVisit=async(routeStop=null)=>{
    if(activeVisit){
      alert("Finish the current visit first.");
      return;
    }
    const selectedStop=routeStop || todayRouteStops.find(s=>s.id===form.route_stop_id);
    const shopId=selectedStop?.shop_id || form.shop_id;
    if(todayRouteStops.length&&form.route_stop_id&&!selectedStop){
      alert("Selected route stop was not found. Please choose the shop again.");
      return;
    }
    if(selectedStop&&currentPendingStop&&selectedStop.id!==currentPendingStop.id&&selectedStop.status==="pending"){
      alert(`Please complete stop #${currentPendingStop.sequence_no} first.`);
      return;
    }
    if(!shopId){
    ...
    const duplicate=visits.find(v=>
      ...
      v.shop_id===shopId &&
      visitDate(v)===today &&
      (selectedStop?.id ? v.route_stop_id===selectedStop.id || v.id===selectedStop.assigned_visit_id : true) &&
      ["in_progress","pending_review","approved","completed"].includes(visitStatus(v))
    );
    if(duplicate){
      if(visitStatus(duplicate)==="in_progress")setActiveVisit(duplicate);
      alert("A visit already exists for this assigned stop today.");
      return;
    }
    try{
      ...
      const gpsVariance=gpsStatus==="Suspicious";
      const now=new Date().toISOString();
      const data={
        user_id:user.id,
        merchandiser_id:user.id,
        shop_id:shopId,
        route_stop_id:selectedStop?.id||null,
        ...
        gps_variance_detected:gpsVariance,
        is_fake_visit:false,
        status:"in_progress",
      ...
      const rows=await db(VISIT_TABLE,"insert",{data});
      const saved=Array.isArray(rows)&&rows.length?rows[0]:data;
      setActiveVisit(saved);
      setVisits(prev=>[saved,...prev]);
      if(selectedStop){
        await updateRouteStop(selectedStop.id,{status:"in_progress",assigned_visit_id:saved.id});
        if(activeRoute?.status==="published")await updateRouteStatus(activeRoute.id,"in_progress");
      }
      if(gpsVariance){
        alert(`Visit started. GPS variance detected: you are ${distance} km from ${shop?.name||"the shop"}.`);
      }else{
  ...
  const endVisit=async()=>{
    ...
    try{
      ...
      const data={
        ...
        distance_status:gpsStatus,
        gps_status:gpsStatus,
        gps_variance_detected:gpsStatus==="Suspicious",
        is_fake_visit:false,
        status:gpsStatus==="Confirmed"?"completed":"pending_review",
      ...
      await db(VISIT_TABLE,"update",{data,eq:{id:activeVisit.id}});
      setVisits(prev=>prev.map(v=>v.id===activeVisit.id?{...v,...data}:v));
      if(activeVisit.route_stop_id){
        await updateRouteStop(activeVisit.route_stop_id,{status:"completed",assigned_visit_id:activeVisit.id});
        const nextStops=todayRouteStops.map(s=>s.id===activeVisit.route_stop_id?{...s,status:"completed",assigned_visit_id:activeVisit.id}:s);
        if(activeRoute&&nextStops.length&&nextStops.every(s=>s.status==="completed"||s.status==="skipped")){
          await updateRouteStatus(activeRoute.id,"completed");
        }
      }
      setActiveVisit(null);
      setForm({shop_id:"",route_stop_id:"",display_notes:"",stock_issue:"",competitor_activity:"",order_request:"",before_image_url:"",after_image_url:""});
      alert("Visit submitted for manager review. Check-out GPS and duration saved.");
    }catch(e){
      alert("GPS permission is required to end visit.");
    }
  };

  const reviewVisit=async(id,status,existingComment="")=>{
    let managerComment=existingComment;
    if(["rejected","flagged"].includes(status)){
      managerComment=prompt(status==="flagged"?"Manager comment required for flagging this visit:":"Manager comment required for rejecting this visit:",existingComment||"")||"";
      if(!managerComment.trim()){
        alert("Manager comment is required for Reject or Flag.");
        return;
      }
    }
    const approvalStatus=status==="approved"?"Approved":status==="rejected"?"Rejected":"Pending";
    const data={status,approval_status:approvalStatus,approved_by:user.id,management_comment:managerComment,manager_comment:managerComment,review_comment:managerComment};
    await db(VISIT_TABLE,"update",{data,eq:{id}});
  ...
  const flagVisit=async(id,existingComment="")=>{
    await reviewVisit(id,"flagged",existingComment);
  };
  ...
  return <div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(135px,1fr))",gap:10,marginBottom:14}}>
      ...
      <StatCard label="In Progress" value={visibleVisits.filter(v=>visitStatus(v)==="in_progress").length} color="#C4A747" style={compactCardStyle}/>
      <StatCard label="Completed" value={visibleVisits.filter(v=>visitStatus(v)==="completed").length} color="#0F6E56" style={compactCardStyle}/>
      <StatCard label="GPS Variance" value={visibleVisits.filter(hasGpsVariance).length} color="#C74C51" style={compactCardStyle}/>
      <StatCard label="Pending Review" value={visibleVisits.filter(v=>visitStatus(v)==="pending_review").length} color="#C4A747" style={compactCardStyle}/>
    </div>
    ...
    {isManager&&<Card style={{marginBottom:14,padding:"14px 16px"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(160px,1fr))",gap:10}}>
        ...
        <Select value={filters.status} onChange={v=>setFilters(f=>({...f,status:v}))} style={{width:"100%"}}>
          ...
          <option value="gps_variance">GPS Variance</option>
        </Select>
    ...
    {!isManager&&<Card style={{marginBottom:14,padding:"14px 16px"}}>
      <div style={{display:"flex",justifyContent:"space-between",gap:10,alignItems:"center",flexWrap:"wrap",marginBottom:12}}>
        <div>
          <div style={{fontSize:15,fontWeight:700,color:"#1F1F1F"}}>My Route Today</div>
          <div style={{fontSize:12,color:"#777777",marginTop:3}}>{activeRoute?`${todayRouteStops.length} assigned stops in sequence`:"No route assigned for today"}</div>
        </div>
        {activeRoute&&<StatusBadge s={activeRoute.status}/>}
      </div>
      {todayRouteStops.length?<div style={{display:"grid",gap:10}}>
        {todayRouteStops.map(stop=>{
          const shop=shops.find(s=>s.id===stop.shop_id);
          const area=areas?.find(a=>a.id===shop?.area_id);
          const visit=visitForStop(stop);
          const status=visit?visitStatus(visit):stop.status;
          const canStart=!visit && stop.status!=="completed" && (!currentPendingStop || currentPendingStop.id===stop.id);
          return <div key={stop.id} style={{border:"1px solid #E8E8E8",borderRadius:12,padding:12,display:"grid",gridTemplateColumns:"48px minmax(0,1fr) auto",gap:12,alignItems:"center",background:status==="completed"?"#F7FBF9":"#FFFFFF"}}>
            <div style={{width:42,height:42,borderRadius:12,background:"#E8F5F1",color:"#0F6E56",display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800}}>#{stop.sequence_no}</div>
            <div style={{minWidth:0}}>
              <div style={{fontSize:14,fontWeight:700,color:"#1F1F1F",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{shop?.name||"Shop"} {shop?.branch?`- ${shop.branch}`:""}</div>
              <div style={{fontSize:12,color:"#777777",marginTop:3}}>{area?.name||shop?.location||"Area not set"} · Planned stop {stop.sequence_no}</div>
              <div style={{marginTop:6}}><StatusBadge s={status}/></div>
            </div>
            <Btn variant={canStart?"primary":"default"} size="sm" onClick={()=>startVisit(stop)} style={{minWidth:110}}>{canStart?"📍 Start Visit":status==="completed"?"Completed":"Waiting"}</Btn>
          </div>;
        })}
      </div>:<div style={{border:"1px dashed #D5D5D5",borderRadius:12,padding:16,color:"#777777",fontSize:13}}>Your manager has not published a route for today. Assigned-shop fallback is still available for older data.</div>}
    </Card>}
    ...
    <Card style={{marginBottom:14,padding:"14px 16px"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(180px,1fr))",gap:10}}>
        <div>
          ...
          <Select value={form.shop_id} onChange={v=>setForm(f=>({...f,shop_id:v,route_stop_id:todayRouteStops.find(s=>s.shop_id===v)?.id||""}))} style={{width:"100%"}}>
            <option value="">Select shop</option>
            {assignedShops.map((s,index)=><option key={s.id} value={s.id}>{routeShopIds.has(s.id)?`${todayRouteStops.find(stop=>stop.shop_id===s.id)?.sequence_no||index+1}. `:""}{s.name} {s.branch?`- ${s.branch}`:""}</option>)}
          </Select>
        </div>
        <div>
      ...
      {selectedShop&&<div style={{marginTop:10,background:"#F9F9F9",border:"1px solid #E8E8E8",borderRadius:10,padding:10,display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(150px,1fr))",gap:8}}>
        <div style={{fontSize:12,color:"#666666"}}><b>Checklist</b><br/>{selectedShop.route_order?`#${selectedShop.route_order} · ${selectedShop.store_type||""}`:"Standard shop"}</div>
    ...
    <Card className="lewa-visits-table-card" style={{padding:0,overflow:"hidden"}}>
      <Table headers={["Staff","Shop","Area","Check-in","Check-out","Duration","GPS","Map","Before","After","Comment","Approval"]}
        className="lewa-visits-table"
        rows={visibleVisits.map(v=>{
          ...
          return [
            ...
            canApprove&&["pending_review","completed","flagged"].includes(visitStatus(v))?<div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
              <Btn size="sm" variant="success" onClick={()=>reviewVisit(v.id,"approved",comment)}>Approve</Btn>
              <Btn size="sm" variant="danger" onClick={()=>reviewVisit(v.id,"rejected",comment)}>Reject</Btn>
              <Btn size="sm" variant="gold" onClick={()=>flagVisit(v.id,comment)}>Flag</Btn>
            </div>:<StatusBadge s={visitStatus(v)}/>
          ];
        })}/>
    </Card>
          ...
          <div>
            ...
            {isManager?<div>
              ...
              <div style={{display:"flex",gap:8,marginTop:8,flexWrap:"wrap"}}>
                ...
                {v.id&&<Btn size="sm" variant="success" onClick={()=>reviewVisit(v.id,"approved",commentDraft)}>Approve</Btn>}
                {v.id&&<Btn size="sm" variant="danger" onClick={()=>reviewVisit(v.id,"rejected",commentDraft)}>Reject</Btn>}
                {v.id&&<Btn size="sm" variant="gold" onClick={()=>flagVisit(v.id,commentDraft)}>Flag</Btn>}
              </div>
...
// DAILY ROUTE PLAN
function DailyRoutePlanPage({user,shops,profiles,areas,visits,daily_routes,setDailyRoutes,daily_route_stops,setDailyRouteStops,setPage}){
  const today=new Date().toISOString().split("T")[0];
  const managerRoles=["Admin","MD","Chief Manager","Monitoring Manager"];
  const isManager=managerRoles.includes(user.role);
  const isMerchandiser=user.role==="Merchandiser";
  const merchandisers=profiles.filter(p=>p.role==="Merchandiser"&&p.status!=="Inactive");

  const [routeDate,setRouteDate]=useState(today);
  const [merchandiserId,setMerchandiserId]=useState(merchandisers[0]?.id||"");
  ...
  const shopLabel=shop=>`${shop?.name||"Shop"}${shop?.branch?` - ${shop.branch}`:""}`;
  const areaName=shop=>areas?.find(a=>a.id===shop?.area_id)?.name||shop?.location||"Area not set";
  const visitOwnerId=v=>v.user_id||v.merchandiser_id;
  const visitDate=v=>v.visit_date || (v.check_in_time?String(v.check_in_time).split("T")[0]:today);
  const visitForStop=stop=>{
    const route=(daily_routes||[]).find(r=>r.id===stop.route_id);
    return visits.find(v=>v.id===stop.assigned_visit_id) ||
      visits.find(v=>v.shop_id===stop.shop_id&&visitDate(v)===route?.route_date&&visitOwnerId(v)===route?.merchandiser_id);
  };

  const myRoute=(daily_routes||[]).find(r=>
    r.route_date===today &&
    r.merchandiser_id===user.id &&
    ["published","in_progress","completed"].includes(r.status)
  );
  const myStops=myRoute
    ? (daily_route_stops||[]).filter(s=>s.route_id===myRoute.id).sort((a,b)=>(a.sequence_no||0)-(b.sequence_no||0))
    : [];
  const currentPendingStop=myStops.find(stop=>!visitForStop(stop)&&stop.status==="pending");

  const routeList=(daily_routes||[])
    .filter(r=>isManager || r.merchandiser_id===user.id)
    .sort((a,b)=>String(b.route_date).localeCompare(String(a.route_date)));

  const filteredShops=shops
    .filter(shop=>{
      const hay=`${shop.name} ${shop.branch||""} ${shop.location||""}`.toLowerCase();
      return !shopSearch || hay.includes(shopSearch.toLowerCase());
    })
    .sort((a,b)=>(a.route_order||999)-(b.route_order||999)||shopLabel(a).localeCompare(shopLabel(b)));
  ...
  const addShop=()=>{
    ...
    if(draftStops.some(s=>s.shop_id===selectedShopId)){
      alert("This shop is already in the route.");
      return;
    }
    setDraftStops(prev=>[...prev,{id:`draft-${Date.now()}`,shop_id:selectedShopId,sequence_no:prev.length+1,status:"pending",notes:""}]);
    setSelectedShopId("");
  };

  const reorderStops=stops=>stops.map((stop,index)=>({...stop,sequence_no:index+1}));
  const moveStop=(index,dir)=>{
    const next=[...draftStops];
    const target=index+dir;
    if(target<0||target>=next.length)return;
    [next[index],next[target]]=[next[target],next[index]];
    setDraftStops(reorderStops(next));
  };
  const removeStop=index=>setDraftStops(reorderStops(draftStops.filter((_,i)=>i!==index)));

  const editRoute=route=>{
    const stops=(daily_route_stops||[]).filter(s=>s.route_id===route.id).sort((a,b)=>(a.sequence_no||0)-(b.sequence_no||0));
    setEditingRouteId(route.id);
    setRouteDate(route.route_date);
    setMerchandiserId(route.merchandiser_id);
    setNotes(route.notes||"");
    setDraftStops(stops.map(s=>({...s})));
  };

  const saveRoute=async(status)=>{
    if(!isManager)return;
    if(!routeDate||!merchandiserId){
      alert("Select date and merchandiser.");
      return;
    }
    if(!draftStops.length){
      alert("Add at least one shop stop.");
      return;
    }
    const merch=profiles.find(p=>p.id===merchandiserId);
    const area=areas?.find(a=>a.id===merch?.area_id);
    const now=new Date().toISOString();
    const routeData={route_date:routeDate,merchandiser_id:merchandiserId,area_id:merch?.area_id||null,area_name:area?.name||"",status,notes,created_by:user.id,updated_at:now};
    let routeId=editingRouteId;
    let savedRoute={id:routeId,...routeData};
    if(routeId){
      // Live Supabase migration required: daily_routes must exist before saved route updates can persist.
      await db(ROUTE_TABLE,"update",{data:routeData,eq:{id:routeId}});
      setDailyRoutes(prev=>prev.map(r=>r.id===routeId?{...r,...routeData}:r));
    }else{
      // Live Supabase migration required: daily_routes must exist before managers can create live route plans.
      const rows=await db(ROUTE_TABLE,"insert",{data:{...routeData,created_at:now}});
      savedRoute=Array.isArray(rows)&&rows.length?rows[0]:{id:`route-${Date.now()}`,...routeData,created_at:now};
      routeId=savedRoute.id;
      setDailyRoutes(prev=>[savedRoute,...prev]);
    }

    // Live Supabase migration required: daily_route_stops must exist before ordered route stops can persist.
    await db(ROUTE_STOP_TABLE,"delete",{eq:{route_id:routeId}});
    const stopRows=[];
    for(const [index,stop] of draftStops.entries()){
      const stopData={route_id:routeId,shop_id:stop.shop_id,sequence_no:index+1,status:stop.status==="completed"?"completed":"pending",assigned_visit_id:stop.assigned_visit_id||null,notes:stop.notes||"",created_at:stop.created_at||now,updated_at:now};
      const rows=await db(ROUTE_STOP_TABLE,"insert",{data:stopData});
      stopRows.push(Array.isArray(rows)&&rows.length?rows[0]:{id:`stop-${Date.now()}-${index}`,...stopData});
    }
    setDailyRouteStops(prev=>[...prev.filter(s=>s.route_id!==routeId),...stopRows]);
    setEditingRouteId(routeId);
    alert(status==="published"?"Route published to merchandiser.":"Route saved as draft.");
  };

  const publishExisting=async(route)=>{
    const updatedAt=new Date().toISOString();
    await db(ROUTE_TABLE,"update",{data:{status:"published",updated_at:updatedAt},eq:{id:route.id}});
    setDailyRoutes(prev=>prev.map(r=>r.id===route.id?{...r,status:"published",updated_at:updatedAt}:r));
  };

  if(user.role==="Driver"){
    return <div>
      <PageHeader title="Daily Route Plan" subtitle="Route planning access is not enabled for driver accounts"/>
      <Card><div style={{fontSize:14,color:"#777777"}}>Drivers use Delivery Tracking for assigned deliveries.</div></Card>
    </div>;
  }

  if(isMerchandiser){
    return <div>
      <PageHeader title="My Route Today" subtitle="Assigned shops are shown in manager-planned sequence"/>
      <Card style={{marginBottom:14}}>
        <div style={{display:"flex",justifyContent:"space-between",gap:10,alignItems:"center",flexWrap:"wrap",marginBottom:14}}>
          <div>
            <div style={{fontSize:15,fontWeight:700,color:"#1F1F1F"}}>{myRoute?`${myStops.length} shops assigned today`:"No route assigned"}</div>
            <div style={{fontSize:12,color:"#777777",marginTop:4}}>{fmtDate(today)} {myRoute?.area_name?`· ${myRoute.area_name}`:""}</div>
          </div>
          {myRoute&&<StatusBadge s={myRoute.status}/>}
        </div>
        {myStops.length?<div style={{display:"grid",gap:10}}>
          {myStops.map(stop=>{
            const shop=shops.find(s=>s.id===stop.shop_id);
            const visit=visitForStop(stop);
            const status=visit?normalizeVisitStatus(visit.status):stop.status;
            const canStart=!visit && (!currentPendingStop || currentPendingStop.id===stop.id);
            return <div key={stop.id} style={{border:"1px solid #E8E8E8",borderRadius:12,padding:12,display:"grid",gridTemplateColumns:"48px minmax(0,1fr) auto",gap:12,alignItems:"center",background:status==="completed"?"#F7FBF9":"#FFFFFF"}}>
              <div style={{width:42,height:42,borderRadius:12,background:"#E8F5F1",color:"#0F6E56",display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800}}>#{stop.sequence_no}</div>
              <div style={{minWidth:0}}>
                <div style={{fontSize:14,fontWeight:700,color:"#1F1F1F",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{shopLabel(shop)}</div>
                <div style={{fontSize:12,color:"#777777",marginTop:3}}>{areaName(shop)} · Planned sequence {stop.sequence_no}</div>
                <div style={{marginTop:6}}><StatusBadge s={status}/></div>
              </div>
              <Btn variant={canStart?"primary":"default"} size="sm" onClick={()=>setPage("Merchandiser Visits")} style={{minWidth:116}}>{canStart?"📍 Start Visit":status==="completed"?"Completed":"Open Visits"}</Btn>
            </div>;
          })}
        </div>:<div style={{border:"1px dashed #D5D5D5",borderRadius:12,padding:18,fontSize:14,color:"#777777"}}>No published route is assigned to you today.</div>}
      </Card>
    </div>;
  }

  return <div>
    <PageHeader title="Daily Route Plan" subtitle="Create and publish daily shop routes for merchandisers"/>

    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(160px,1fr))",gap:12,marginBottom:14}}>
      <StatCard label="Routes Today" value={routeList.filter(r=>r.route_date===today).length}/>
      <StatCard label="Published" value={routeList.filter(r=>r.status==="published").length} color="#0F6E56"/>
      <StatCard label="In Progress" value={routeList.filter(r=>r.status==="in_progress").length} color="#378ADD"/>
      <StatCard label="Draft" value={routeList.filter(r=>r.status==="draft").length} color="#888780"/>
    </div>

    <Card style={{marginBottom:14}}>
      <div style={{display:"flex",justifyContent:"space-between",gap:10,alignItems:"center",flexWrap:"wrap",marginBottom:14}}>
        <div style={{fontSize:16,fontWeight:700,color:"#1F1F1F"}}>{editingRouteId?"Edit Route":"Create Route"}</div>
        {editingRouteId&&<Btn size="sm" onClick={resetBuilder}>New Route</Btn>}
      </div>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(180px,1fr))",gap:10,marginBottom:12}}>
        <div>
          <label style={{fontSize:12,fontWeight:700,color:"#666666",display:"block",marginBottom:5}}>Route date</label>
          <Input type="date" value={routeDate} onChange={setRouteDate}/>
        </div>
        <div>
          <label style={{fontSize:12,fontWeight:700,color:"#666666",display:"block",marginBottom:5}}>Merchandiser</label>
          <Select value={merchandiserId} onChange={setMerchandiserId} style={{width:"100%"}}>
            <option value="">Select merchandiser</option>
            {merchandisers.map(m=><option key={m.id} value={m.id}>{m.full_name}</option>)}
          </Select>
        </div>
        <div>
          <label style={{fontSize:12,fontWeight:700,color:"#666666",display:"block",marginBottom:5}}>Shop search</label>
          <Input value={shopSearch} onChange={setShopSearch} placeholder="Search shops"/>
        </div>
        <div>
          <label style={{fontSize:12,fontWeight:700,color:"#666666",display:"block",marginBottom:5}}>Add shop</label>
          <div style={{display:"flex",gap:8}}>
            <Select value={selectedShopId} onChange={setSelectedShopId} style={{width:"100%"}}>
              <option value="">Select shop</option>
              {filteredShops.map(shop=><option key={shop.id} value={shop.id}>{shop.route_order?`${shop.route_order}. `:""}{shopLabel(shop)}</option>)}
            </Select>
            <Btn variant="success" onClick={addShop}>Add</Btn>
          </div>
        </div>
      </div>
      <Input value={notes} onChange={setNotes} placeholder="Route notes"/>

      <div style={{marginTop:14,display:"grid",gap:10}}>
        {draftStops.map((stop,index)=>{
          const shop=shops.find(s=>s.id===stop.shop_id);
          return <div key={stop.id} style={{display:"grid",gridTemplateColumns:"44px minmax(0,1fr) auto",gap:10,alignItems:"center",border:"1px solid #E8E8E8",borderRadius:12,padding:10,background:"#FFFFFF"}}>
            <div style={{width:38,height:38,borderRadius:10,background:"#E8F5F1",color:"#0F6E56",display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800}}>{index+1}</div>
            <div style={{minWidth:0}}>
              <div style={{fontSize:14,fontWeight:700,color:"#1F1F1F",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{shopLabel(shop)}</div>
              <div style={{fontSize:12,color:"#777777",marginTop:3}}>{areaName(shop)}</div>
            </div>
            <div style={{display:"flex",gap:6,flexWrap:"wrap",justifyContent:"flex-end"}}>
              <Btn size="sm" onClick={()=>moveStop(index,-1)}>↑</Btn>
              <Btn size="sm" onClick={()=>moveStop(index,1)}>↓</Btn>
              <Btn size="sm" variant="danger" onClick={()=>removeStop(index)}>Remove</Btn>
            </div>
          </div>;
        })}
        {!draftStops.length&&<div style={{border:"1px dashed #D5D5D5",borderRadius:12,padding:16,color:"#777777",fontSize:13}}>Select shops to build the ordered route.</div>}
      </div>
      <div style={{display:"flex",gap:10,flexWrap:"wrap",marginTop:16}}>
        <Btn variant="default" onClick={()=>saveRoute("draft")}>Save Draft</Btn>
        <Btn variant="primary" onClick={()=>saveRoute("published")}>Publish Route</Btn>
      </div>
    </Card>

    <Card style={{padding:0,overflow:"hidden"}}>
      <Table headers={["Date","Merchandiser","Area","Stops","Status","Actions"]}
        rows={routeList.map(route=>{
          const staff=profiles.find(p=>p.id===route.merchandiser_id);
          const stops=(daily_route_stops||[]).filter(s=>s.route_id===route.id);
          return [
            <span style={{fontSize:13,fontWeight:700}}>{fmtDate(route.route_date)}</span>,
            <div style={{display:"flex",alignItems:"center",gap:10}}><Avatar name={staff?.full_name} role={staff?.role} size={30}/><div><div style={{fontSize:13,fontWeight:700}}>{staff?.full_name||"—"}</div><div style={{fontSize:11,color:"#999999"}}>{staff?.employee_id||""}</div></div></div>,
            <span style={{fontSize:13}}>{route.area_name||areas?.find(a=>a.id===route.area_id)?.name||"—"}</span>,
            <span style={{fontSize:13}}>{stops.length}</span>,
            <StatusBadge s={route.status}/>,
            <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
              <Btn size="sm" onClick={()=>editRoute(route)}>Edit</Btn>
              {route.status==="draft"&&<Btn size="sm" variant="success" onClick={()=>publishExisting(route)}>Publish</Btn>}
            </div>
          ];
        })}/>
    </Card>
...
function ReportsPage({profiles,attendance,visits,deliveries,lpos,scores,areas,shops}){
  ...
  return <div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(160px,1fr))",gap:12,marginBottom:16}}>
      ...
      <StatCard label="Completed" value={todayVis.filter(v=>["completed","pending_review","approved"].includes(normalizeVisitStatus(v.status))).length} color="#0F6E56"/>
      ...
      <StatCard label="GPS Variance" value={todayVis.filter(v=>v.gps_variance_detected||proximityStatus(v.distance_from_shop)==="Suspicious").length} color="#C74C51"/>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20,marginBottom:20}}>
      <Card>
        ...
        {areas.map(a=>{
          ...
          const done=aVis.filter(v=>["completed","pending_review","approved"].includes(normalizeVisitStatus(v.status))).length;
          return<div key={a.id} style={{display:"flex",alignItems:"center",gap:12,padding:"10px 0",borderBottom:"1px solid #E5E5E5"}}>
...
// USERS PAGE
function UsersPage({user,profiles,setProfiles,areas,userPasswords,setUserPasswords,themeMode}){
  const [modal,setModal]=useState(null);
  const [form,setForm]=useState({});
  const [createPasswordForm,setCreatePasswordForm]=useState({password:"",confirm:""});
  ...
  const existingUsernames=id=>profiles
    .filter(p=>p.username&&p.id!==id)
    .map(p=>normalizeUsername(p.username));

  const openCreate=()=>{
    setForm({status:"Active",role:"Merchandiser"});
    setCreatePasswordForm({password:"",confirm:""});
    setShowCreatePassword(false);
    setError("");
    setModal("create");
  };
  const openEdit=p=>{
    setForm({...p,username:normalizeUsername(p.username)});
    setError("");
    setModal("edit");
  };
  const closeModal=()=>{
  ...
  const save=async()=>{
    ...
    if(existingUsernames(form.id).includes(username)){
      setError("Username already exists.");
      return;
    }
    const payload={...form,username};
    if(modal==="create"){
      if(!createPasswordForm.password||createPasswordForm.password.length<6){
        setError("Temporary password must be at least 6 characters.");
        return;
      }
      if(createPasswordForm.password!==createPasswordForm.confirm){
        setError("Temporary password and confirm password do not match.");
        return;
      }
      const rows=await db("profiles","insert",{data:{...payload,id:`demo-${Date.now()}`}});
      if(rows.length){
        setProfiles(prev=>[rows[0],...prev]);
        setUserPasswords(prev=>({...prev,[username]:createPasswordForm.password}));
      }
    }else{
      const prevUser=profiles.find(p=>p.id===form.id);
      await db("profiles","update",{data:payload,eq:{id:form.id}});
      setProfiles(prev=>prev.map(p=>p.id===form.id?payload:p));
      if(prevUser){
        const prevUsername=normalizeUsername(prevUser.username);
        if(prevUsername&&prevUsername!==username){
          setUserPasswords(prev=>{
            const next={...prev};
            if(next[prevUsername]!==undefined){
              next[username]=next[prevUsername];
              delete next[prevUsername];
            }else if(userPasswords[prevUsername]!==undefined){
              next[username]=userPasswords[prevUsername];
            }
            return next;
          });
        }
  ...
  const saveResetPassword=()=>{
    const username=normalizeUsername(resetTarget?.username);
    if(!username){
      setResetError("Username is missing.");
      return;
    }
    ...
    if(resetPasswordForm.password!==resetPasswordForm.confirm){
      setResetError("Temporary password and confirm password do not match.");
      return;
    }
    setUserPasswords(prev=>({...prev,[username]:resetPasswordForm.password}));
    setShowResetPassword(false);
    setResetTarget(null);
    setResetPasswordForm({password:"",confirm:""});
    setResetError("");
    alert("Temporary password updated for this demo user.");
  };

  return<div>
    <PageHeader title="User Management" subtitle={`${profiles.length} users · ${profiles.filter(p=>p.status==="Active").length} active`}
      action={<Btn variant="primary" onClick={openCreate}>+ Add User</Btn>}/>
    <Card style={{padding:0,overflow:"hidden"}}>
      <Table headers={["User","Role","Area","Status","Last Login","Actions"]}
        rows={profiles.map(p=>{
          const area=areas.find(a=>a.id===p.area_id);
          return[
            <div className="user-management-visible-user" style={{display:"flex",alignItems:"center",gap:12,opacity:1,filter:"none",mixBlendMode:"normal",visibility:"visible",color:"inherit"}}>
              <Avatar name={p.full_name} role={p.role} size={36}/>
              <div style={{opacity:1,filter:"none",mixBlendMode:"normal",visibility:"visible",color:"inherit"}}>
                <div className="user-management-visible-user-name" style={{color:themeMode==="dark"?"#FFFFFF":"#1F2937",fontWeight:700,fontSize:"14px",opacity:1,visibility:"visible",lineHeight:1.25}}>
                  {p.full_name}
                </div>
                {p.id==="u1"&&<div style={{color:themeMode==="dark"?"#FFFFFF":"#1F2937",fontWeight:700,fontSize:"12px",opacity:1,visibility:"visible",lineHeight:1.25,marginTop:2}}>DARK MODE NAME TEST</div>}
                <div className="user-management-visible-user-detail" style={{color:themeMode==="dark"?"#D9E5E1":"#667085",fontWeight:500,fontSize:"11px",opacity:1,visibility:"visible",lineHeight:1.35}}>
                  {p.employee_id} · {p.mobile}
                </div>
              </div>
            </div>,
            <Badge label={p.role}/>,
            ...
            <span style={{fontSize:"13px",color:"var(--lewa-text-muted)"}}>{fmt(p.last_login)||"Never"}</span>,
            <div style={{display:"flex",gap:6}}>
              <Btn size="sm" onClick={()=>openEdit(p)}>Edit</Btn>
              {user.role==="Admin"&&<Btn size="sm" variant="ghost" onClick={()=>openReset(p)}>Reset Password</Btn>}
              <Btn size="sm" variant="danger" onClick={()=>del(p.id)}>Delete</Btn>
            </div>
          ];
        })}/>
    </Card>
    {modal&&<Modal title={modal==="create"?"Add User":"Edit User"} onClose={closeModal} width={"520px"}>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"0 16px",marginBottom:14}}>
        <div style={{marginBottom:14}}>
          <label style={{fontSize:"12px",fontWeight:"600",color:"#666666",display:"block",marginBottom:6}}>Full Name</label>
          <Input value={form.full_name} onChange={v=>setForm(f=>({...f,full_name:v}))}/>
        </div>
        <div style={{marginBottom:14}}>
          <label style={{fontSize:"12px",fontWeight:"600",color:"#666666",display:"block",marginBottom:6}}>Employee ID</label>
          <Input value={form.employee_id} onChange={v=>setForm(f=>({...f,employee_id:v}))}/>
        </div>
        <div style={{marginBottom:14}}>
          <label style={{fontSize:"12px",fontWeight:"600",color:"#666666",display:"block",marginBottom:6}}>Mobile</label>
          <Input value={form.mobile} onChange={v=>setForm(f=>({...f,mobile:v}))}/>
        </div>
        <div style={{marginBottom:14}}>
          <label style={{fontSize:"12px",fontWeight:"600",color:"#666666",display:"block",marginBottom:6}}>Email</label>
          <Input value={form.email} onChange={v=>setForm(f=>({...f,email:v}))}/>
        </div>
        <div style={{marginBottom:14}}>
          <label style={{fontSize:"12px",fontWeight:"600",color:"#666666",display:"block",marginBottom:6}}>Username</label>
          <Input value={form.username} onChange={v=>setForm(f=>({...f,username:normalizeUsername(v)}))}/>
        </div>
        <div style={{marginBottom:14}}>
        ...
        {modal==="create"&&<>
          <div style={{marginBottom:14}}>
            <label style={{fontSize:"12px",fontWeight:"600",color:"#666666",display:"block",marginBottom:6}}>Temporary Password</label>
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              <Input value={createPasswordForm.password} onChange={v=>setCreatePasswordForm(f=>({...f,password:v}))} type={showCreatePassword?"text":"password"} placeholder="Enter temporary password" style={{flex:1}}/>
              <button type="button" aria-label={showCreatePassword?"Hide password":"Show password"} onClick={()=>setShowCreatePassword(v=>!v)} style={{minWidth:44,height:44,border:"1.5px solid var(--lewa-border)",borderRadius:10,background:"var(--lewa-surface-2)",color:"var(--lewa-text)",cursor:"pointer",flexShrink:0}}>{showCreatePassword?"🙈":"👁️"}</button>
            </div>
          </div>
          <div style={{marginBottom:14}}>
            <label style={{fontSize:"12px",fontWeight:"600",color:"#666666",display:"block",marginBottom:6}}>Confirm Password</label>
            <Input value={createPasswordForm.confirm} onChange={v=>setCreatePasswordForm(f=>({...f,confirm:v}))} type={showCreatePassword?"text":"password"} placeholder="Confirm temporary password"/>
          </div>
        </>}
        <div style={{marginBottom:14}}>
        ...
        {modal==="create"&&<div style={{gridColumn:"1 / -1",fontSize:"12px",color:"var(--lewa-text-muted)",marginTop:-4,marginBottom:10,lineHeight:1.4}}>Share the temporary password securely. Ask the employee to change it after first login.</div>}
        {error&&<div style={{gridColumn:"1 / -1",color:"#C74C51",fontSize:"12px",fontWeight:"600",marginTop:-4}}>{error}</div>}
      </div>
      <div style={{display:"flex",justifyContent:"flex-end",gap:10,marginTop:20,paddingTop:16,borderTop:"1px solid #E5E5E5"}}>
        <Btn onClick={()=>setModal(null)}>Cancel</Btn>
    ...
    {showResetPassword&&resetTarget&&<Modal title={`Reset Password - ${resetTarget.full_name}`} onClose={()=>{setShowResetPassword(false);setResetTarget(null);setResetError("");}} width={"420px"}>
      <div style={{display:"grid",gap:14}}>
        <div>
          <label style={{fontSize:"12px",fontWeight:"600",color:"#666666",display:"block",marginBottom:6}}>New Temporary Password</label>
          <Input value={resetPasswordForm.password} onChange={v=>setResetPasswordForm(f=>({...f,password:v}))} type="password" placeholder="Enter new temporary password"/>
        </div>
        <div>
          <label style={{fontSize:"12px",fontWeight:"600",color:"#666666",display:"block",marginBottom:6}}>Confirm Password</label>
          <Input value={resetPasswordForm.confirm} onChange={v=>setResetPasswordForm(f=>({...f,confirm:v}))} type="password" placeholder="Confirm new password"/>
        </div>
        <div style={{fontSize:"12px",color:"var(--lewa-text-muted)",lineHeight:1.4}}>Share the temporary password securely. Ask the employee to change it after first login.</div>
        {resetError&&<div style={{color:"#C74C51",fontSize:"12px",fontWeight:"600"}}>{resetError}</div>}
        <div style={{display:"flex",justifyContent:"flex-end",gap:10}}>
          <Btn onClick={()=>{setShowResetPassword(false);setResetTarget(null);setResetError("");}}>Cancel</Btn>
          <Btn variant="primary" onClick={saveResetPassword}>Save Password</Btn>
        </div>
      </div>
    </Modal>}
  </div>;
...
function LoginScreen({company_settings,loginForm,setLoginForm,loginError,onLogin}){
  return <div className="lewa-login-screen" style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:'"Dubai", "Segoe UI", Tahoma, Arial, sans-serif',background:"linear-gradient(160deg, #E8F5F1 0%, #0B6B2E 52%, #084B20 100%)",padding:24}}>
    <div className="lewa-login-card" style={{width:"100%",maxWidth:420,background:"rgba(255,255,255,0.97)",border:"1.5px solid rgba(255,255,255,0.72)",borderRadius:18,boxShadow:"0 22px 60px rgba(8,75,32,0.26)",padding:30,backdropFilter:"blur(8px)"}}>
      <div className="lewa-login-brand" style={{display:"flex",alignItems:"center",gap:14,marginBottom:26,padding:"14px 16px",borderRadius:16,background:"linear-gradient(135deg, rgba(11,107,46,0.08), rgba(11,107,46,0.16))",border:"1.5px solid rgba(11,107,46,0.18)",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.65)"}}>
        <div className="lewa-login-logo" style={{width:72,height:72,borderRadius:20,background:"#FFFFFF",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",border:"1.5px solid rgba(11,107,46,0.20)",boxShadow:"0 8px 22px rgba(8,75,32,0.18)",flexShrink:0}}>
        ...
        <div>
          <div className="lewa-login-company" style={{fontSize:18,fontWeight:800,color:"#0B6B2E",letterSpacing:0,lineHeight:1.15}}>{company_settings.company_name}</div>
          <div className="lewa-login-subtitle" style={{fontSize:12,color:"#1B5E3F",marginTop:5,fontWeight:600}}>{company_settings.company_subtitle}</div>
          <div style={{fontSize:11,color:"#3E6D55",marginTop:6,fontWeight:600}}>Secure ERP access</div>
        </div>
      </div>
      <form onSubmit={onLogin}>
        <div style={{fontSize:20,fontWeight:700,color:"#1F1F1F",marginBottom:6}}>Sign in</div>
        <div style={{fontSize:13,color:"#355C49",marginBottom:20,fontWeight:500}}>Sign in to continue.</div>
        <div style={{marginBottom:14}}>
          <label style={{fontSize:12,fontWeight:700,color:"#355C49",display:"block",marginBottom:6}}>Account</label>
          <Input value={loginForm.username} onChange={v=>setLoginForm(f=>({...f,username:v}))} placeholder="" />
        </div>
        <div style={{marginBottom:16}}>
          <label style={{fontSize:12,fontWeight:700,color:"#355C49",display:"block",marginBottom:6}}>Secret code</label>
          <Input value={loginForm.password} onChange={v=>setLoginForm(f=>({...f,password:v}))} placeholder="" type="password" />
        </div>
...
export default function App(){
  ...
  const [themeMode,setThemeMode]=useState(()=>{
    ...
    return window.localStorage.getItem("al_lewa_theme")||window.localStorage.getItem("lewa-theme-mode")||"light";
  });
  ...
  const [passwords,setPasswords]=useState({admin:"admin123",ashik:"ashik123",anees:"anees123",shakeel:"shakeel123"});
  const [userPasswords,setUserPasswords]=useState({admin:"admin123",ashik:"ashik123",anees:"anees123",shakeel:"shakeel123",ameen:"ameen123"});
  ...
  // State
  const [areas,setAreas]=useState(()=>initialTable("areas"));
  const [shops,setShops]=useState(()=>initialTable("shops"));
  const [profiles,setProfiles]=useState(()=>initialTable("profiles"));
  const [attendance,setAttendance]=useState(()=>initialTable("attendance"));
  const [visits,setVisits]=useState(()=>initialTable("shop_visits"));
  const [daily_routes,setDailyRoutes]=useState(()=>initialTable("daily_routes"));
  const [daily_route_stops,setDailyRouteStops]=useState(()=>initialTable("daily_route_stops"));
  const [deliveries,setDeliveries]=useState(()=>initialTable("deliveries"));
  const [lpos,setLpos]=useState(()=>initialTable("lpos"));
  const [scores,setScores]=useState(()=>initialTable("daily_scores"));
  const [notifications,setNotifications]=useState(()=>initialTable("notifications"));
  const [authorizations,setAuthorizations]=useState(()=>initialTable("authorizations"));
  const [backup_logs,setBackupLogs]=useState(()=>initialTable("backup_logs"));
  const [login_sessions,setLoginSessions]=useState(()=>initialTable("login_sessions"));
  const [company_settings,setCompanySettings]=useState(MOCK_COMPANY_SETTINGS);
  const [products,setProducts]=useState(()=>initialTable("products"));
  const [memo_documents,setMemoDocuments]=useState(()=>initialTable("memo_documents"));
  const [score_proofs,setScoreProofs]=useState(()=>initialTable("score_proofs"));
  ...
  useEffect(()=>{
    ...
    const shouldLock=mobileMoreOpen&&typeof window!=="undefined"&&window.innerWidth<768;
  ...
  useEffect(()=>{
    ...
    window.localStorage.setItem("al_lewa_theme",themeMode);
    window.localStorage.setItem("lewa-theme-mode",themeMode);
  },[themeMode]);

  const unread=notifications.filter(n=>!n.is_read&&(n.user_id===currentUser.id||["Admin","MD"].includes(currentUser.role))).length;

  const effectiveRole=currentUser.role==="Admin"&&(previewRole||loginAs)?(previewRole||loginAs):currentUser.role;
  const navItems=NAV_ITEMS[effectiveRole]||NAV_ITEMS["Admin"];
  ...
  const sharedProps={user:currentUser,areas,setAreas,shops,setShops,profiles,setProfiles,userPasswords,setUserPasswords,attendance,setAttendance,visits,setVisits,daily_routes,setDailyRoutes,daily_route_stops,setDailyRouteStops,deliveries,setDeliveries,lpos,setLpos,scores,setScores,notifications,setNotifications,authorizations,setAuthorizations,backup_logs,setBackupLogs,login_sessions,setLoginSessions,company_settings,setCompanySettings,products,setProducts,memo_documents,setMemoDocuments,score_proofs,setScoreProofs,canEdit,canApprove,setPage};

  const pwaProps={onInstallApp:handleInstallApp,canInstallApp:!!installPrompt,isStandalone};
  const isDark=themeMode==="dark";
  const currentPageAllowed=canAccessPageByRole(currentUser.role,page);
  const dashboardGreeting=greetingForUser(currentUser);

  useEffect(()=>{
    if(authenticated&&!currentPageAllowed){
      setPage("Dashboard");
    }
  },[authenticated,currentPageAllowed]);
  ...
  const pageMap={
    ...
    "Daily Route Plan":<DailyRoutePlanPage {...sharedProps}/>,
  ...
  const globalPwaStyles=<style>{`
    :root {
      --lewa-surface: #FFFFFF;
      --lewa-surface-2: #FAFBFB;
      --lewa-border: #D6D9D8;
      --lewa-text: #1F1F1F;
      --lewa-text-muted: #6F7472;
      --lewa-shell: #F5F5F7;
    }
    :root[data-theme="dark"] {
      --lewa-surface: #1C2422;
      --lewa-surface-2: #23302D;
      --lewa-border: #3A4A46;
      --lewa-text: #F4F7F6;
      --lewa-text-muted: #C5D0CB;
      --lewa-shell: #101615;
    }
    :root .user-management-visible-user,
    :root .user-management-visible-user * {
      opacity: 1 !important;
      filter: none !important;
      mix-blend-mode: normal !important;
    }
    :root[data-theme="dark"] .user-management-visible-user-name {
      color: #FFFFFF !important;
      opacity: 1 !important;
      visibility: visible !important;
      text-shadow: none !important;
    }
    :root[data-theme="dark"] .user-management-visible-user-detail {
    ...
    .lewa-mobile-bottom-nav { display: none; }
    .lewa-mobile-more-panel { display: none; }
    body, button, input, select, textarea {
      font-family: "Dubai", "Segoe UI", Tahoma, Arial, sans-serif;
    }
    body {
      background: var(--lewa-shell);
      color: var(--lewa-text);
    }
    .lewa-app-shell button {
      color: var(--lewa-text);
    }
    .lewa-app-shell button span {
      color: inherit;
    }
    .lewa-app-shell button:disabled,
    .lewa-app-shell button[aria-disabled="true"] {
      color: var(--lewa-text-muted) !important;
      opacity: 0.78 !important;
    }
    .lewa-app-shell input,
    .lewa-app-shell select,
    .lewa-app-shell textarea {
      color: var(--lewa-text);
      caret-color: var(--lewa-text);
    }
    .lewa-app-shell input::placeholder,
    .lewa-app-shell textarea::placeholder {
      color: var(--lewa-text-muted);
      opacity: 1;
    }
    .lewa-app-shell option {
      background: var(--lewa-surface);
      color: var(--lewa-text);
    }
    .lewa-app-shell .lewa-sidebar,
    .lewa-app-shell .lewa-topbar,
    .lewa-app-shell .lewa-main-shell,
    .lewa-app-shell .lewa-mobile-bottom-nav,
    .lewa-app-shell .lewa-mobile-more-panel,
    .lewa-app-shell .lewa-card,
    .lewa-app-shell .lewa-stat-card,
    .lewa-app-shell .lewa-table-wrap,
    .lewa-app-shell table,
    .lewa-app-shell th,
    .lewa-app-shell td,
    .lewa-app-shell input,
    .lewa-app-shell select,
    ...
    :root[data-theme="dark"] .lewa-app-shell .lewa-topbar {
      background: linear-gradient(180deg, #18302A 0%, #13231F 100%) !important;
      border-bottom-color: #2E403A !important;
      box-shadow: 0 2px 12px rgba(0,0,0,0.38) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar {
      background: var(--lewa-surface) !important;
      border-right-color: var(--lewa-border) !important;
      box-shadow: 0 2px 14px rgba(0,0,0,0.28) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-bottom-nav {
      background: #18211E !important;
      border-top-color: var(--lewa-border) !important;
      box-shadow: 0 -8px 20px rgba(0,0,0,0.32) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel {
      background: rgba(16,22,21,0.98) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-card,
    :root[data-theme="dark"] .lewa-app-shell .lewa-stat-card,
    :root[data-theme="dark"] .lewa-app-shell .lewa-visits-table tr,
    :root[data-theme="dark"] .lewa-app-shell table,
    :root[data-theme="dark"] .lewa-app-shell th,
    :root[data-theme="dark"] .lewa-app-shell td,
    :root[data-theme="dark"] .lewa-app-shell input,
    :root[data-theme="dark"] .lewa-app-shell select,
    :root[data-theme="dark"] .lewa-app-shell textarea {
      background-color: var(--lewa-surface) !important;
      color: var(--lewa-text) !important;
      border-color: var(--lewa-border) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-table-wrap thead th {
      background: #22302C !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content,
    :root[data-theme="dark"] .lewa-app-shell .lewa-main-shell {
      background: var(--lewa-shell) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-topbar-company,
    :root[data-theme="dark"] .lewa-app-shell .lewa-topbar-page-title,
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar,
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar button,
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar div,
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar span,
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel,
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel button,
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel div,
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel span {
      color: var(--lewa-text) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel button {
      background: var(--lewa-surface-2) !important;
      border-color: var(--lewa-border) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell button,
    :root[data-theme="dark"] .lewa-app-shell button span {
      color: var(--lewa-text) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell button[data-variant="primary"],
    :root[data-theme="dark"] .lewa-app-shell button[data-variant="success"],
    :root[data-theme="dark"] .lewa-app-shell button[data-variant="danger"],
    :root[data-theme="dark"] .lewa-app-shell button[data-variant="gold"] {
      color: #FFFFFF !important;
    }
    :root[data-theme="dark"] .lewa-app-shell button:disabled,
    :root[data-theme="dark"] .lewa-app-shell button[aria-disabled="true"] {
      color: var(--lewa-text-muted) !important;
    ...
    :root[data-theme="dark"] .lewa-app-shell .lewa-card *,
    :root[data-theme="dark"] .lewa-app-shell .lewa-stat-card *,
    :root[data-theme="dark"] .lewa-app-shell .lewa-table-wrap *,
    :root[data-theme="dark"] .lewa-app-shell .lewa-login-card *,
    :root[data-theme="dark"] .lewa-app-shell .lewa-login-brand *,
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal *,
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-header *,
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content input,
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content select,
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content textarea,
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar input,
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar select,
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar textarea,
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel input,
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel select,
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel textarea {
      color: var(--lewa-text) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content p,
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar p,
    :root[data-theme="dark"] .lewa-app-shell .lewa-topbar p,
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel p,
    :root[data-theme="dark"] .lewa-app-shell .lewa-card p,
    :root[data-theme="dark"] .lewa-app-shell .lewa-stat-card p,
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-header p,
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content span,
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar span,
    :root[data-theme="dark"] .lewa-app-shell .lewa-topbar span,
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel span,
    :root[data-theme="dark"] .lewa-app-shell .lewa-card span,
    :root[data-theme="dark"] .lewa-app-shell .lewa-stat-card span,
    :root[data-theme="dark"] .lewa-app-shell .lewa-table-wrap td,
    :root[data-theme="dark"] .lewa-app-shell .lewa-table-wrap th,
    :root[data-theme="dark"] .lewa-app-shell .lewa-login-card label,
    :root[data-theme="dark"] .lewa-app-shell .lewa-login-card div,
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal label,
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal div {
      color: var(--lewa-text) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content .lewa-card [style*=\"color:#999\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content .lewa-card [style*=\"color:#666\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content .lewa-card [style*=\"color:#777\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*=\"color:#999\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*=\"color:#666\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*=\"color:#777\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal [style*=\"color:#999\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal [style*=\"color:#666\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal [style*=\"color:#777\"] {
      color: var(--lewa-text-muted) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell input::placeholder,
    :root[data-theme="dark"] .lewa-app-shell textarea::placeholder,
    :root[data-theme="dark"] .lewa-app-shell select::placeholder {
      color: var(--lewa-text-muted) !important;
      opacity: 1 !important;
    }
    :root[data-theme="dark"] .lewa-app-shell input,
    ...
    :root[data-theme="dark"] .lewa-app-shell option {
      background: var(--lewa-surface-2) !important;
      color: var(--lewa-text) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal,
    ...
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*=\"color:#1F1F1F\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content [style*=\"color:#1F1F1F\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal [style*=\"color:#1F1F1F\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-topbar [style*=\"color:#1F1F1F\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel [style*=\"color:#1F1F1F\"] {
      color: var(--lewa-text) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*=\"color:#999999\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content [style*=\"color:#999999\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal [style*=\"color:#999999\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-topbar [style*=\"color:#999999\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel [style*=\"color:#999999\"] {
      color: var(--lewa-text-muted) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*=\"color:#666666\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content [style*=\"color:#666666\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal [style*=\"color:#666666\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-topbar [style*=\"color:#666666\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel [style*=\"color:#666666\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*=\"color:#777777\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content [style*=\"color:#777777\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal [style*=\"color:#777777\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-topbar [style*=\"color:#777777\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel [style*=\"color:#777777\"] {
      color: var(--lewa-text-muted) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*=\"background:#F5F5F5\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content [style*=\"background:#F5F5F5\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal [style*=\"background:#F5F5F5\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*=\"background:#FFFFFF\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content [style*=\"background:#FFFFFF\"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-modal [style*=\"background:#FFFFFF\"] {
      background: var(--lewa-surface) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-mobile-more-panel .lewa-mobile-drawer-nav button.is-active {
      background: linear-gradient(180deg, rgba(15,110,86,0.18), rgba(15,110,86,0.1)) !important;
      color: #F4F7F6 !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-table-wrap thead th,
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content table thead th {
      color: var(--lewa-text) !important;
    }
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content [style*="Last Login"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-page-content [style*="Reset Password"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*="font-size:11px"],
    :root[data-theme="dark"] .lewa-app-shell .lewa-sidebar [style*="font-size:12px"] {
      color: var(--lewa-text-muted) !important;
    }
    ...
    @media (max-width: 767px) {
      ...
      .lewa-login-screen {
        ...
        background: linear-gradient(160deg, #E8F5F1 0%, #0B6B2E 52%, #084B20 100%) !important;
      }
      .lewa-login-card {
      ...
      .lewa-topbar .theme-toggle,
      .lewa-topbar-actions .lewa-demo-badge,
      .lewa-topbar-actions .lewa-password-button,
      .lewa-topbar-actions .lewa-logout-button,
      .lewa-topbar-actions .lewa-notification-button {
        display: none !important;
      }
      .lewa-topbar-mobile-title {
        display: none !important;
      }
      ...
      .lewa-table-wrap tr {
        background: var(--lewa-surface) !important;
        border: 1px solid var(--lewa-border) !important;
        border-radius: 12px !important;
      ...
      .lewa-table-wrap td {
        ...
        font-size: 15px !important;
        line-height: 1.35 !important;
        border-bottom: 1px solid var(--lewa-border) !important;
      }
      ...
      .lewa-mobile-bottom-nav {
        ...
        border-top: 1.5px solid #D7DEDB !important;
        box-shadow: 0 -10px 24px rgba(0,0,0,0.10) !important;
        padding: 6px 6px calc(env(safe-area-inset-bottom) + 6px) !important;
      }
      .lewa-mobile-bottom-nav button {
      ...
      .lewa-mobile-bottom-nav button.is-active {
        color: #0F6E56 !important;
        background: linear-gradient(180deg, #E8F5F1, #D8F0E7) !important;
        box-shadow: inset 0 0 0 1px rgba(15,110,86,0.12) !important;
      }
      .lewa-mobile-bottom-nav button span.icon {
        font-size: 18px !important;
        line-height: 1 !important;
      }
      .lewa-mobile-drawer-header {
        display: flex !important;
      }
      .lewa-mobile-drawer-theme {
        display: flex !important;
      }
      .lewa-mobile-more-panel {
        display: block !important;
        position: fixed !important;
        top: 0 !important;
        left: 0 !important;
        ...
        padding: 12px 12px calc(130px + env(safe-area-inset-bottom)) 12px !important;
        border-right: 1.5px solid var(--lewa-border) !important;
        box-shadow: 18px 0 40px rgba(0,0,0,0.35) !important;
      }
      .lewa-mobile-drawer-section {
        display: block !important;
      }
      .lewa-mobile-drawer-nav button {
        border: 1.5px solid var(--lewa-border) !important;
        background: var(--lewa-surface-2) !important;
        color: var(--lewa-text) !important;
      }
      .lewa-mobile-drawer-nav button.is-active {
        background: linear-gradient(180deg, rgba(15,110,86,0.12), rgba(15,110,86,0.08)) !important;
        color: #0F6E56 !important;
      }
      .lewa-mobile-drawer-close {
        display: inline-flex !important;
      }
      .lewa-mobile-drawer-profile {
        display: block !important;
      }
      .lewa-mobile-more-panel .lewa-mobile-drawer-header,
      .lewa-mobile-more-panel .lewa-mobile-drawer-section,
      .lewa-mobile-more-panel .lewa-mobile-drawer-theme,
      .lewa-mobile-more-panel .lewa-mobile-drawer-profile,
      .lewa-mobile-more-panel .lewa-mobile-drawer-close,
      .lewa-mobile-more-panel .lewa-mobile-drawer-nav button,
      .lewa-mobile-more-panel .lewa-mobile-drawer-nav span,
      .lewa-mobile-more-panel .lewa-mobile-drawer-nav div,
      .lewa-mobile-more-panel .lewa-mobile-drawer-theme span,
      .lewa-mobile-more-panel .lewa-mobile-drawer-theme div,
      .lewa-mobile-more-panel .lewa-mobile-drawer-profile span,
      .lewa-mobile-more-panel .lewa-mobile-drawer-profile div,
      .lewa-mobile-more-panel .lewa-mobile-drawer-profile button,
      .lewa-mobile-more-panel select {
        color: var(--lewa-text) !important;
      }
      .lewa-mobile-more-panel .lewa-mobile-drawer-nav button,
      .lewa-mobile-more-panel .lewa-mobile-drawer-theme button,
      .lewa-mobile-more-panel select {
        background: var(--lewa-surface-2) !important;
        border: 1.5px solid var(--lewa-border) !important;
      }
      .lewa-mobile-more-panel .lewa-mobile-drawer-nav button.is-active {
        background: linear-gradient(180deg, rgba(15,110,86,0.14), rgba(15,110,86,0.08)) !important;
        color: #0F6E56 !important;
      }
  ...
  return(
    <div className="lewa-app-shell" style={{display:"flex",height:"100vh",fontFamily:'"Dubai, "Segoe UI", Tahoma, Arial, sans-serif',background:"var(--lewa-shell)",overflow:"hidden"}}>
      {globalPwaStyles}
      {systemBanners}
      {sidebarOpen&&<div className="lewa-sidebar-scrim" onClick={()=>{setSidebarOpen(false);setMobileMoreOpen(false);}} />}
      {/* SIDEBAR */}
      <div className={`lewa-sidebar ${sidebarOpen?"is-open":"is-closed"}`} style={{width:sidebarOpen?236:68,flexShrink:0,background:"linear-gradient(180deg,var(--lewa-surface),var(--lewa-surface-2))",borderRight:"1.5px solid var(--lewa-border)",display:"flex",flexDirection:"column",transition:"width 0.2s ease",overflow:"hidden",boxShadow:"0 8px 22px rgba(0,0,0,0.08)"}}>
        <div style={{padding:"12px 14px",borderBottom:"1.5px solid var(--lewa-border)",display:"flex",alignItems:"center",gap:14,minWidth:240,background:"linear-gradient(180deg,rgba(15,110,86,0.04),transparent)"}}>
          <div style={{width:50,height:50,borderRadius:14,background:"var(--lewa-surface-2)",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",border:"1.5px solid var(--lewa-border)",boxShadow:"0 2px 8px rgba(0,0,0,0.08)",flexShrink:0}}>
            <img src={company_settings.company_logo_url||DEFAULT_LOGO} alt="Al Lewa General Trading LLC" style={{width:"100%",height:"100%",objectFit:"contain"}} />
          </div>
          {sidebarOpen&&<div style={{minWidth:0,display:"flex",flexDirection:"column",gap:2}}><div style={{fontWeight:"700",fontSize:"14px",color:"var(--lewa-text)",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{company_settings.company_name}</div><div style={{fontSize:"10px",color:"var(--lewa-text-muted)",letterSpacing:"0.06em"}}>{company_settings.company_subtitle}</div></div>}
          <button onClick={()=>{setSidebarOpen(o=>!o);setMobileMoreOpen(false);}} style={{marginLeft:"auto",background:"none",border:"none",cursor:"pointer",color:"#999999",fontSize:"18px",padding:"6px",flexShrink:0,transition:"color 0.2s"}}>☰</button>
        </div>

        {/* Role switcher (admin preview only) */}
        {sidebarOpen&&currentUser.role==="Admin"&&DEMO_MODE&&<div style={{padding:"10px 12px",borderBottom:"1.5px solid var(--lewa-border)",background:"var(--lewa-surface-2)"}}>
          <div style={{fontSize:"10px",color:"var(--lewa-text-muted)",marginBottom:6,textTransform:"uppercase",letterSpacing:"0.08em",fontWeight:"600"}}>Admin Preview Only</div>
          <div style={{fontSize:"11px",color:"var(--lewa-text-muted)",marginBottom:8,lineHeight:1.35}}>Preview mode does not change the logged-in account.</div>
          <select value={previewRole||currentUser.role} onChange={e=>switchUser(e.target.value)} style={{width:"100%",padding:"7px 10px",border:"1px solid var(--lewa-border)",borderRadius:6,background:"var(--lewa-surface)",color:"var(--lewa-text)",fontSize:"12px",fontWeight:"500",cursor:"pointer"}}>
            {ROLES.map(r=><option key={r} value={r}>{r}</option>)}
          </select>
        </div>}

        <nav style={{flex:1,overflowY:"auto",padding:"12px 10px",display:"grid",gap:4}}>
          {navItems.map(item=>(
            <button key={item} onClick={()=>selectPage(item)}
              style={{display:"flex",alignItems:"center",gap:12,width:"100%",padding:"10px 10px",borderRadius:12,border:"1px solid transparent",cursor:"pointer",background:page===item?"linear-gradient(180deg, rgba(15,110,86,0.12), rgba(15,110,86,0.08))":"transparent",color:page===item?"#0F6E56":"var(--lewa-text)",fontWeight:page===item?"700":"600",fontSize:"13px",textAlign:"left",whiteSpace:"nowrap",position:"relative",transition:"all 0.2s",boxShadow:page===item?"inset 0 0 0 1px rgba(15,110,86,0.10)":"none"}}>
              <span style={{flexShrink:0,fontSize:"16px"}}>
                {{"Dashboard":"🏠","Users":"👥","Authorizations":"✅","Session Tracker":"🔐","Geographic Areas":"🗺️","Daily Route Plan":"🗺️","Shops":"🏪","Areas":"📍","Attendance":"📋","Visits":"🚶","My Visits":"🚶","Deliveries":"🚛","My Deliveries":"🚛","LPO":"📄","Sales Orders":"💼","My Shops":"🏪","Scores":"⭐","Rankings":"🏆","Reports":"📊","Training / Demo Video":"🎬","Notifications":"🔔","Settings":"⚙️"}[item]||MODULE_ICONS[item]||"•"}
              </span>
        ...
        {sidebarOpen&&<div style={{padding:"12px 14px",borderTop:"1.5px solid var(--lewa-border)",background:"linear-gradient(180deg,var(--lewa-surface-2),rgba(15,110,86,0.03))"}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            <Avatar name={currentUser.full_name} role={currentUser.role} size={36}/>
            <div style={{minWidth:0,flex:1}}>
              <div style={{fontSize:"12px",fontWeight:"600",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",color:isDark?"#FFFFFF":"#1F2937",opacity:1}}>{currentUser.full_name}</div>
              <div style={{fontSize:"11px",color:isDark?"#D9E5E1":"#667085",opacity:1}}><Badge label={currentUser.role}/></div>
            </div>
          </div>
        </div>}
      </div>
      ...
      {/* MAIN */}
      <div className="lewa-main-shell" style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column",background:"var(--lewa-shell)"}}>
        {/* TOPBAR */}
        <div className="lewa-topbar" style={{height:page==="Dashboard"?"auto":58,minHeight:page==="Dashboard"?72:58,borderBottom:"1.5px solid rgba(255,255,255,0.16)",background:"linear-gradient(180deg, #0F6E56 0%, #0C5B47 100%)",display:"flex",alignItems:"center",justifyContent:"space-between",padding:page==="Dashboard"?"8px 16px":"0 16px",flexShrink:0,boxShadow:"0 6px 18px rgba(8,75,32,0.22)"}}>
          <button className="lewa-mobile-menu-btn" onClick={()=>{setSidebarOpen(true);setMobileMoreOpen(true);}} style={{display:"none",background:"transparent",border:"none",fontSize:24,color:"#0F6E56",cursor:"pointer",padding:"6px 8px"}}>☰</button>
          <div className="lewa-topbar-brand" style={{display:"flex",alignItems:"center",gap:10,flex:1,minWidth:0}}>
            <div className="lewa-topbar-logo" style={{width:46,height:46,display:"none",alignItems:"center",justifyContent:"center",background:"var(--lewa-surface-2)",borderRadius:16,overflow:"hidden",border:"1.5px solid var(--lewa-border)",flexShrink:0}}>
              <img src={company_settings.company_logo_url||DEFAULT_LOGO} alt="Al Lewa General Trading LLC" style={{width:"100%",height:"100%",objectFit:"contain"}} />
            </div>
            <div style={{display:"flex",flexDirection:"column",minWidth:0,overflow:"hidden",flex:1}}>
              <div style={{display:"flex",alignItems:"baseline",gap:10,minWidth:0,flexWrap:"wrap"}}>
                <span className="lewa-topbar-company" style={{fontSize:"15px",fontWeight:"700",color:"#FFFFFF",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis",maxWidth:"100%"}}>{company_settings.company_name}</span>
                <span className="lewa-topbar-arabic" dir="rtl" lang="ar" style={{fontSize:"12px",fontWeight:"700",color:"#D9FBEA",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>الليوا للتجارة العامة</span>
              </div>
              <span className="lewa-topbar-subtitle" style={{fontSize:"12px",color:"#D9FBEA",marginTop:3,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{company_settings.company_subtitle}</span>
              {page==="Dashboard"&&<span className="lewa-topbar-greeting" style={{fontSize:"12px",fontWeight:"700",color:"#FFFFFF",marginTop:3,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{dashboardGreeting}</span>}
              <span className="lewa-topbar-mobile-title" style={{display:"none",fontSize:"13px",fontWeight:"700",color:"#FFFFFF",marginTop:2,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{company_settings.company_name}</span>
            </div>
          </div>
          <div className="lewa-topbar-actions" style={{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap",justifyContent:"flex-end",flexShrink:0}}>
            {currentUser.role==="Admin"&&DEMO_MODE&&<span className="lewa-demo-badge lewa-topbar-demo-badge" style={{fontSize:"11px",background:"rgba(254,249,231,0.95)",color:"#8D7320",padding:"7px 11px",borderRadius:14,fontWeight:"700",border:"1px solid rgba(232,216,168,0.95)",boxShadow:"0 4px 12px rgba(0,0,0,0.08)"}}>Demo Mode</span>}
            <ThemeToggle isDark={isDark} onClick={()=>setThemeMode(m=>m==="dark"?"light":"dark")} />
            ...
            <Btn className="lewa-password-button" size="sm" variant="ghost" onClick={()=>setShowPasswordModal(true)} style={{minWidth:44,justifyContent:"center"}}><span className="desktop-button-text">Password</span><span className="mobile-button-icon">⚙️</span></Btn>
            <Btn className="lewa-logout-button" size="sm" variant="danger" onClick={handleLogout} style={{minWidth:44,justifyContent:"center"}}><span className="desktop-button-text">Logout</span><span className="mobile-button-icon">⏻</span></Btn>
          </div>
        </div>

        {/* PAGE CONTENT */}
        <div className="lewa-page-content" style={{flex:1,padding:"2rem 2rem",maxWidth:"1400px",width:"100%",margin:"0 auto",boxSizing:"border-box",overflowY:"auto",color:"var(--lewa-text)"}}>
          {!currentPageAllowed?<Card style={{maxWidth:520,margin:"0 auto"}}><div style={{fontSize:14,fontWeight:700,color:"var(--lewa-text)",marginBottom:6}}>You do not have permission to access this module.</div><div style={{fontSize:12,color:"var(--lewa-text-muted)"}}>You have been returned to Dashboard.</div></Card>:pageMap[page]||<div><p style={{color:"#999999"}}>Page not found.</p></div>}
        </div>
      </div>
      {typeof window!=="undefined"&&window.innerWidth<768&&<>
      <div className={`lewa-mobile-more-panel ${mobileMoreOpen?"is-open":""}`} onClick={e=>{if(e.target===e.currentTarget){setMobileMoreOpen(false);setSidebarOpen(false);}}} style={{transform:mobileMoreOpen?"translateX(0)":"translateX(-105%)",pointerEvents:mobileMoreOpen?"auto":"none"}}>
          <div className="lewa-mobile-drawer-header" style={{display:"none",alignItems:"center",justifyContent:"space-between",gap:12,padding:"4px 4px 12px",borderBottom:"1.5px solid var(--lewa-border)",marginBottom:12}}>
            <div style={{display:"flex",alignItems:"center",gap:10,minWidth:0}}>
              <div style={{width:42,height:42,borderRadius:12,background:"var(--lewa-surface-2)",border:"1.5px solid var(--lewa-border)",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",flexShrink:0}}>
                <img src={company_settings.company_logo_url||DEFAULT_LOGO} alt="Al Lewa General Trading LLC" style={{width:"100%",height:"100%",objectFit:"contain"}} />
              </div>
              <div style={{minWidth:0}}>
                <div style={{fontSize:14,fontWeight:700,color:"var(--lewa-text)",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{company_settings.company_name}</div>
                <div style={{fontSize:11,color:"var(--lewa-text-muted)",marginTop:2,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{company_settings.company_subtitle}</div>
              </div>
            </div>
            <button className="lewa-mobile-drawer-close" onClick={()=>{setMobileMoreOpen(false);setSidebarOpen(false);}} style={{display:"none",width:40,height:40,alignItems:"center",justifyContent:"center",border:"1.5px solid var(--lewa-border)",borderRadius:12,background:"var(--lewa-surface-2)",color:"var(--lewa-text)",cursor:"pointer",flexShrink:0}}>✕</button>
          </div>

          {currentUser.role==="Admin"&&DEMO_MODE&&<div className="lewa-mobile-drawer-section" style={{display:"block",padding:"10px 0 12px",borderBottom:"1.5px solid var(--lewa-border)"}}>
            <div style={{fontSize:10,color:"var(--lewa-text-muted)",marginBottom:6,textTransform:"uppercase",letterSpacing:"0.08em",fontWeight:700}}>Admin Preview Only</div>
            <div style={{fontSize:11,color:"var(--lewa-text-muted)",marginBottom:8,lineHeight:1.35}}>Preview mode does not change the logged-in account.</div>
            <select value={previewRole||currentUser.role} onChange={e=>switchUser(e.target.value)} style={{width:"100%",padding:"10px 12px",border:"1.5px solid var(--lewa-border)",borderRadius:10,background:"var(--lewa-surface-2)",color:"var(--lewa-text)",fontSize:13,fontWeight:600,cursor:"pointer"}}>
              {ROLES.map(r=><option key={r} value={r}>{r}</option>)}
            </select>
          </div>}

          <div className="lewa-mobile-drawer-section" style={{display:"block",padding:"10px 0 12px",borderBottom:"1.5px solid var(--lewa-border)"}}>
            <div style={{fontSize:10,color:"var(--lewa-text-muted)",marginBottom:8,textTransform:"uppercase",letterSpacing:"0.08em",fontWeight:700}}>Navigation</div>
            <div className="lewa-mobile-drawer-nav" style={{display:"grid",gap:8}}>
              {navItems.map(item=>(
                <button key={item} onClick={()=>selectPage(item)} style={{display:"flex",alignItems:"center",gap:10,width:"100%",padding:"11px 12px",borderRadius:12,border:"1.5px solid var(--lewa-border)",cursor:"pointer",background:page===item?"linear-gradient(180deg, rgba(15,110,86,0.12), rgba(15,110,86,0.08))":"var(--lewa-surface-2)",color:page===item?"#0F6E56":"var(--lewa-text)",fontWeight:page===item?"700":"600",fontSize:"13px",textAlign:"left",boxShadow:page===item?"inset 0 0 0 1px rgba(15,110,86,0.10)":"none"}}>
                  <span style={{fontSize:18,flexShrink:0}}>{{"Dashboard":"🏠","Users":"👥","Authorizations":"✅","Session Tracker":"🔐","Geographic Areas":"🗺️","Daily Route Plan":"🗺️","Shops":"🏪","Areas":"📍","Attendance":"📋","Visits":"🚶","My Visits":"🚶","Deliveries":"🚛","My Deliveries":"🚛","LPO":"📄","Sales Orders":"💼","My Shops":"🏪","Scores":"⭐","Rankings":"🏆","Reports":"📊","Training / Demo Video":"🎬","Notifications":"🔔","Settings":"⚙️"}[item]||MODULE_ICONS[item]||"•"}</span>
                  <span style={{flex:1,color:"inherit"}}>{item}{item==="Notifications"&&unread>0&&<span style={{marginLeft:8,background:"#C74C51",color:"#FFFFFF",borderRadius:12,padding:"2px 8px",fontSize:"10px",fontWeight:"700"}}>{unread}</span>}</span>
                </button>
              ))}
            </div>
          </div>

          <div className="lewa-mobile-drawer-theme" style={{display:"block",padding:"10px 0 12px",borderBottom:"1.5px solid var(--lewa-border)",minHeight:52}}>
            <div style={{fontSize:10,color:"var(--lewa-text-muted)",marginBottom:8,textTransform:"uppercase",letterSpacing:"0.08em",fontWeight:700}}>Theme</div>
            <button onClick={()=>setThemeMode(m=>m==="dark"?"light":"dark")} className="theme-toggle" style={{display:"inline-flex",alignItems:"center",gap:10,width:"100%",minHeight:52,border:"1.5px solid var(--lewa-border)",borderRadius:14,padding:"12px 12px",background:"var(--lewa-surface-2)",color:"var(--lewa-text)",cursor:"pointer",fontWeight:700}}>
              <span style={{fontSize:17,lineHeight:1,flexShrink:0}}>{isDark?"🌙":"☀️"}</span>
              <span style={{fontSize:13,whiteSpace:"nowrap",flex:1,textAlign:"left"}}>{isDark?"Dark Mode":"Light Mode"}</span>
              <span style={{marginLeft:"auto",display:"inline-flex",alignItems:"center",width:48,height:28,padding:3,borderRadius:999,background:isDark?"#16362D":"rgba(255,255,255,0.55)",border:"1px solid var(--lewa-border)",boxSizing:"border-box",flexShrink:0}}>
                <span style={{width:20,height:20,borderRadius:"50%",background:"var(--lewa-surface)",transform:isDark?"translateX(20px)":"translateX(0)",transition:"transform 0.2s ease, background 0.2s ease",boxShadow:"0 2px 6px rgba(0,0,0,0.22)"}} />
              </span>
            </button>
          </div>

          <div className="lewa-mobile-drawer-profile" style={{display:"block",padding:"12px 0 4px"}}>
            <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10}}>
              <Avatar name={currentUser.full_name} role={currentUser.role} size={38}/>
              <div style={{minWidth:0,flex:1}}>
                <div style={{fontSize:13,fontWeight:700,color:"var(--lewa-text)",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{currentUser.full_name}</div>
                <div style={{fontSize:11,color:"var(--lewa-text-muted)",marginTop:2}}><Badge label={currentUser.role}/></div>
              </div>
            </div>
            <Btn size="sm" variant="danger" onClick={handleLogout} style={{width:"100%",justifyContent:"center"}}>Logout</Btn>
          </div>
        </div>
        <div className="lewa-mobile-bottom-nav">
          {[
            {label:"Dashboard",icon:MODULE_ICONS.Dashboard,page:"Dashboard"},
            {label:"Shops",icon:MODULE_ICONS["Shops & Locations"],page:"Shops & Locations"},
            {label:"Route",icon:MODULE_ICONS["Daily Route Plan"],page:"Daily Route Plan"},
            {label:"Visits",icon:MODULE_ICONS["Merchandiser Visits"],page:"Merchandiser Visits"},
            {label:"More",icon:"☰",page:"MORE"}
          ].map(item=>(
            <button key={item.label} className={page===item.page?"is-active":""} onClick={()=>{
              if(item.page==="MORE"){setSidebarOpen(true);setMobileMoreOpen(true);return;}
