...
const NAV_ITEMS = {
  "Admin":["Dashboard","Users & Authorization","Authorizations","Session Tracker","Shops & Locations","Geographic Areas","Product Master","Attendance","Daily Route Plan","Merchandiser Visits","Delivery Tracking","LPO Management","Sales Orders","Daily Scores","Backup Logs","Memo/Documents","Reports","Notifications","Settings"],
  "MD":["Dashboard","Users & Authorization","Authorizations","Session Tracker","Shops & Locations","Geographic Areas","Product Master","Attendance","Daily Route Plan","Merchandiser Visits","Delivery Tracking","LPO Management","Sales Orders","Daily Scores","Backup Logs","Memo/Documents","Reports","Notifications","Settings"],
  "Chief Manager":["Dashboard","Users & Authorization","Authorizations","Shops & Locations","Geographic Areas","Attendance","Daily Route Plan","Merchandiser Visits","Delivery Tracking","LPO Management","Sales Orders","Daily Scores","Memo/Documents","Reports","Notifications","Settings"],
  "Monitoring Manager":["Dashboard","Users & Authorization","Authorizations","Shops & Locations","Geographic Areas","Attendance","Daily Route Plan","Merchandiser Visits","Daily Scores","Memo/Documents","Reports","Notifications","Settings"],
  "Merchandiser":["Dashboard","Shops & Locations","Attendance","Daily Route Plan","Merchandiser Visits","LPO Management","Daily Scores","Memo/Documents","Reports","Notifications","Settings"],
  ...
  return <div>
    ...
    <Card style={{marginBottom:12,overflowX:"auto"}}>
      <div style={{display:"flex",justifyContent:"space-between",gap:12,alignItems:"center",marginBottom:12,flexWrap:"wrap"}}>
        <div>
          <div style={{fontWeight:"700",fontSize:"14px",color:"var(--lewa-text)"}}>Training / Demo Video</div>
          <div style={{fontSize:"12px",color:"var(--lewa-text-muted)",marginTop:4}}>Use the Lewa brand video for onboarding and demo playback.</div>
        </div>
        <Badge label="Media" />
      </div>
      <div style={{minWidth:0,overflow:"hidden",borderRadius:12,border:"1.5px solid var(--lewa-border)",background:"var(--lewa-surface-2)"}}>
        <video
          controls
          playsInline
          preload="metadata"
          muted
          style={{display:"block",width:"100%",maxWidth:"100%",aspectRatio:"16 / 9",objectFit:"cover",background:"#000000"}}
...
export default function App(){
  ...
  const [themeMode,setThemeMode]=useState(()=>{
    ...
    return window.localStorage.getItem("lewa-theme-mode")||"light";
  });
  ...
  return(
    <div className="lewa-app-shell" style={{display:"flex",height:"100vh",fontFamily:"'Segoe UI', -apple-system, BlinkMacSystemFont, sans-serif",background:"var(--lewa-shell)",overflow:"hidden"}}>
      {globalPwaStyles}
      {systemBanners}
          ...
          {navItems.map(item=>(
            <button key={item} onClick={()=>selectPage(item)}
              ...
              <span style={{flexShrink:0,fontSize:"16px"}}>
                {{"Dashboard":"🏠","Users":"👥","Authorizations":"✅","Session Tracker":"🔐","Geographic Areas":"🗺️","Daily Route Plan":"🗺️","Shops":"🏪","Areas":"📍","Attendance":"📋","Visits":"🚶","My Visits":"🚶","Deliveries":"🚛","My Deliveries":"🚛","LPO":"📄","Sales Orders":"💼","My Shops":"🏪","Scores":"⭐","Rankings":"🏆","Reports":"📊","Notifications":"🔔","Settings":"⚙️"}[item]||MODULE_ICONS[item]||"•"}
              </span>
          ...
          <div className="menu-grid">
            {navItems.filter(item=>!["Dashboard","Shops & Locations","Merchandiser Visits","Daily Route Plan"].includes(item)).map(item=>(
              <button key={item} onClick={()=>selectPage(item)} style={{border:"1px solid #E8E8E8",background:"#FFFFFF",borderRadius:14,padding:"14px 12px",display:"flex",alignItems:"center",gap:10,textAlign:"left",boxShadow:"0 6px 18px rgba(0,0,0,0.04)"}}>
                <span style={{fontSize:20,flexShrink:0}}>{MODULE_ICONS[item]||"•"}</span>
